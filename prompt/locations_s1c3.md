...
- **添付画像 (2枚、 必須)**:
  - `images/characters/season1/ur/desert_princess.png` (サハナ、 S1C3 ur_08 生成済み前提)
  - `images/enemies/shadeova_sand.png` (野沢さん生成済の砂塵影喰い参照画像)
