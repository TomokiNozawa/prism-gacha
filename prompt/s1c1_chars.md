...
**保存先（このアプリで使う場合）:**
`C:/Users/t2262/Box/DIK & Company/06_Other/野沢用/claude/prismaera/images/characters/seasonN/<tier>/<slug>.png`
...
2. 出力画像を指定ファイル名（例: `ssr_08_elf_archer.png`）で
   `C:/Users/t2262/Box/DIK & Company/06_Other/野沢用/claude/prismaera/images/` に保存
