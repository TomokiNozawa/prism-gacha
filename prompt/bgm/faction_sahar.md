...
> - **既存生成済み**: v1 (BPM 110) で生成 → `prism-sahar.mp3` (3:01) として配置済 (野沢許容範囲)
> - **再生成用 v2** (BPM 130、 up-tempo): 野沢方針 2026-05-01 「やっぱアップテンポ系が好み」 反映、 派閥/戦闘テーマ既定範囲 (BPM 120-140) に揃えた版
...
## 🎵 v1 — Mid-tempo 原版 (BPM 110、 既存 `prism-sahar.mp3` はこちら)
...
## 🎵 v2 — Up-tempo 版 (BPM 130、 野沢方針 2026-05-01)

> 「やっぱアップテンポ系が好み」 を反映。 派閥/戦闘テーマ既定範囲 (BPM 120-140) に揃えた版。 v1 が物足りない時の再生成用 (`feedback_bgm_uptempo.md`)。
