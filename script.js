/* ============================================================
   Prismaera v1.5.1bc — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  SSR: [
    ...
    },
    {
      ...
      caption: "(沈黙、 一礼)",
      desc: "グレイル氷帝の剣師、 二十六-二十七歳。 古代氷霊の血を強く引く一族の若き継承者として、 双の氷剣ヘルファング (ニフルとヘイルの先代型) を受け継ぐ。 寡黙、 弟子グレイルへの信頼は揺らがない。",
...
const LORE_BY_KEY = {
  ...
  "SSR_北方剣聖 ハグル": [
    { title: "グレイルの剣師として", body: "ハグルは二十六、 七歳。 古代氷霊の血を強く引く一族の若き継承者として、 先代氷帝——グレイルの父——の代から剣師を務め始めた。 グレイルが八歳で初めて木剣を握った日、 ハグルは静かに告げた——『若様。 双剣は、 二つの心です。 振るう前に、 二つの心を並べてください』。 グレイルが二十六年、 双剣を磨き続けた根底には、 ハグルの最初のこの一言がある。" },
...
const IMG_CACHE_VERSION = '1.5.1bc';
