/* ============================================================
   Prismaera v1.3.1 — 演出&ゲームロジック (Season 1 第1〜2章)
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    },
    {
      ...
      desc: "見た目は8-10歳の幼女、 中身は千年級。 古龍の血を最も濃く引く一族の長老。 古龍杖ジナを携え、 失われた古龍王の伝承を守る。 自分の身長の三倍はある杖を扱う、 ロリババアの代名詞。 観測者三柱と千年前を共有する縁を持つ。 ヴィルを『次の千年の鍵』 と密かに見定めている。",
