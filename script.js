/* ============================================================
   Prismaera v1.5.1x — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    {
      name: "千年語りのヴィオレナ", season: 1, chapter: 's1c6',
...
const CHAR_FACTION = {
  ...
  '千年語りのヴィオレナ':         { f: 'shrines', dx: -160, dy: -100 },  // 上左 (千年級母)
...
const RELATIONS = [
  ...
  { a: '千年語りのヴィオレナ',         b: 'イリス',                   type: 'blood',     label: '実母と娘 (千年血脈)' },                       // 全章 母娘
  ...
  { a: '千年語りのヴィオレナ',         b: 'セラフィエル',             type: 'fellow',    label: '千年前の旧縁 (月影宮で共祈)' },               // 2-1 再会
  { a: '千年語りのヴィオレナ',         b: '地底市の母 リオラエル',    type: 'fellow',    label: '千年前同期 (観測者の前から在る同世代)' },     // カグヤ千年日記の記録 (3-3)
  { a: '千年語りのヴィオレナ',         b: '千夜姫 カグヤ',            type: 'fellow',    label: '千年前 月影宮で共祈の証人' },                 // 3-3 千年日記
...
const IMG_CACHE_VERSION = '1.5.1x';
