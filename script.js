/* ============================================================
   Prismaera v1.5.1bd — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const LORE_BY_KEY = {
  ...
  "UR_黒月使徒 テネブラ": [
    { title: "千年前のノクトリアとの盟約", body: "テネブラは千年前、 ノクトリア (s1c5、 黒月衆の盟主) と盟友だった。 二人は、 ヴォイドラの召喚に共に立ち会い、 千年閉じ込めの対価を共に背負うと誓った。 だが、 ノクトリアは地上に残り、 黒月衆として千年世界を観続ける道を選んだ。 テネブラは、 ヴォイドラと共に塔に閉じこもる道を選んだ。 二つの「観続ける」 と「観られる」 の道——千年経って、 黒月決戦の戦場で、 ノクトリアとテネブラは、 千年ぶりに再会する。 「待たせたな」——ノクトリアの一言。 テネブラは静かに笑った。" },
    ...
    { title: "S2C5 和解交渉での役目", body: "S2C5「影との和解」 で、 テネブラはノクトリア (s1c5、 黒月衆の盟主) と並ぶ「影側の千年交渉役」 として再登場予定。 千年前の盟友同士の絆が、 千年の沈黙を超えて、 ヴォイドラ陣営と全派閥の和解の橋渡しを担う。 「千年待った夜が、 ようやく来た」——テネブラの黒月決戦前夜の独白。 千年閉じ込められた使徒と、 千年地上で観続けた盟主——二人の千年が、 黒月決戦の翌朝、 ようやく、 同じ朝を迎える。" },
    { title: "ノクトリアへの最後の言葉", body: "黒月決戦の終わり、 ヴォイドラが「世界の影として留まる」 と受諾した瞬間、 テネブラはノクトリアに微かに頷いた。 「私たちの千年は、 ここで一段、 結実したな」——テネブラの言葉。 ノクトリアも、 静かに微笑んだ。 「次は、 影と光の和解を、 共に紡ごう」——ノクトリアの返事。 千年前の盟友が、 千年経って、 ようやく、 共に「次の千年」 を歩み始める瞬間だった。" },
  ],
  "UR_共観の使徒 ジュンクトス": [
  ...
  "SSR_紅玉旗艦砲手長 マロン": [
    ...
    { title: "旗艦砲の威力", body: "紅玉号の旗艦砲は、 千年前にシャンティの祖父が鋳造した、 海賊団の聖具。 マロンは、 千年血脈の砲手の系譜を継ぐ、 三代目の砲手長。 brass-gold の rifle-cannon は、 千年同じ砲座で、 千年同じ威力を保ち続けた。 黒月決戦で、 マロンの砲撃が、 異界塔戦士団の隊列を、 一発で散らせる威力を発揮した。" },
  ...
  "SSR_氷霊魔導長 ノエル": [
    ...
    { title: "古代氷霊魔法の千年継承", body: "ノエルの氷晶の杖は、 千年前の古代氷霊魔法の系譜を、 千年継承している。 千年同じ杖を、 千年同じ戦場で、 千年同じ祈りで振るう。 黒月決戦で、 ノエルの氷魔法は、 異界塔ザナド戦士団の闇の咒術を、 完全に中和した。 千年血脈の魔法 vs 千年閉じ込められた咒術——千年の対決が、 戦場の北東で、 静かに繰り広げられた。" },
  ...
  "SSR_銀霜神官長 ヴィルニル": [
    ...
    { title: "雪月神殿千年血脈の神官", body: "ヴィルニルの月の杖は、 千年前の雪月神殿の創始神官から、 千年継承された聖具。 千年同じ杖を、 千年同じ祭壇で、 千年同じ祈りで振るう。 黒月決戦中も、 ヴィルニルは雪月神殿で祈祷を捧げ続ける支援役。 銀霜陣営の戦力の半分は、 ヴィルニルの千年祈りで支えられている。" },
  ...
  "SSR_巫女連邦軍師 セイラン": [
    ...
    { title: "七色の作戦扇子の千年血脈", body: "セイランの七色の作戦扇子は、 千年前の巫女連邦リーリエの初代軍師から、 千年継承された聖具。 千年同じ扇子を、 千年同じ戦場で、 千年同じ祈りで振るう。 黒月決戦で、 セイランの作戦扇子は、 全派閥の戦力配置を、 七色の light-particle で示した。 千年血脈の戦略担当の祈りが、 戦場全体の連携を、 静かに支えていた。" },
  ...
  "SSR_異界塔執行官 オブスクル": [
    { title: "ザナディア塔主への千年忠誠", body: "オブスクルは、 ザナディア塔主 (s1c7 UR) に千年閉じ込められたまま忠誠を捧げる執行官。 千年同じ塔で、 千年同じ祈りで、 千年同じ剣を振るい続けた。 「塔の意志を、 剣で執行する」——オブスクルの千年血脈の祈り。 黒月決戦の戦場で、 オブスクルの剣は、 ザナディア塔主の千年祈りを、 戦場の中央で、 静かに具現化していた。" },
    { title: "千年閉じ込められた執行官の重み", body: "オブスクルは、 千年閉じ込められた塔の中で、 千年同じ稽古を、 千年同じ場所で続けた。 void-black の longsword は、 千年前にザナディアが鋳造した、 voidtower の聖具。 千年同じ薙刀を、 千年同じ場所で振り続けた。 黒月決戦で、 オブスクルの剣は、 観測者陣営の戦士たちと拮抗する重みを発揮した。" },
    { title: "「共に在る」 への気付き", body: "アルテミス陛下の「共に在る、 が答えだ」 という言葉に、 オブスクルは初めて、 longsword の柄を強く握った。 千年閉じ込められた塔の意志を、 千年「執行する」 と教えられてきたオブスクルにとって、 「共に在る」 という言葉は、 想定外の答えだった。 「執行とは、 そういう意味か」——オブスクルの千年血脈の認識の転換点。 千年閉じ込められた執行官が、 千年祈りの意味を、 戦場の中央で、 ようやく理解する瞬間だった。" },
  ],
  ...
  "SR_異界塔の闇衛 ノクサル": [
    { title: "千年閉じ込められた塔の若き闇兵", body: "ノクサルは、 千年閉じ込められた異界塔ザナドの若き闇衛。 千年同じ塔で、 千年同じ稽古を、 千年同じ場所で続けた。 黒月決戦の戦場で、 ノクサルの void-black halberd は、 オブスクル (s1c7 SSR 執行官) 配下の前線兵として、 千年血脈の闇衛の祈りを、 静かに、 具現化していた。" },
    { title: "オブスクル執行官への忠誠", body: "ノクサルは、 オブスクル執行官に千年閉じ込められたまま忠誠を捧げる若き闇衛。 「塔の意志を、 我が刃で守る」——ノクサルの千年血脈の祈り。 千年祈り続けた闇衛の継承者として、 ノクサルの剣は、 観測者陣営の戦士たちと、 千年血脈の重みで、 拮抗していた。" },
  ],
  "SR_異界塔の魔導兵 アビス": [
    { title: "千年閉じ込められた闇咒術の継承者", body: "アビスは、 千年閉じ込められた異界塔ザナドの若き闇魔導士。 千年同じ咒術を、 千年同じ場所で、 千年同じ祈りで唱え続けた。 「影の咒術を、 解き放つ」——アビスの千年血脈の祈り。 黒月決戦の戦場で、 アビスの void mage staff は、 凍土陣営との魔法戦の前線で、 千年血脈の咒術を、 静かに、 具現化していた。" },
    { title: "ノエル魔導長との千年級対決", body: "アビスは、 氷霊魔導長ノエル (s1c7 SSR) と、 千年血脈の魔導士同士の対決を演じた。 千年血脈の氷魔法 vs 千年閉じ込められた闇咒術——千年の対決が、 戦場の北東で、 静かに繰り広げられた。 アビスの咒術は、 ノエルの氷魔法に完全に中和されたが、 二人の対決は、 千年血脈の祈りの結実だった。" },
  ],
  "SR_異界塔の斥候 グリム": [
    { title: "影の中を歩く偵察兵", body: "グリムは、 千年閉じ込められた異界塔ザナドの若き斥候。 影の中を歩く偵察、 戦線の情報伝達役。 千年同じ偵察を、 千年同じ影の中で、 千年同じ祈りで続けた。 「影は、 私の足跡を消してくれる」——グリムの千年血脈の祈り。" },
  ...
  "R_異界塔の歌手 メル": [
    { title: "千年閉じ込められた歌の継承者", body: "メルは、 異界塔ザナドの若き歌手、 十八-十九歳。 void singer として、 千年閉じ込められた塔の祈祷歌を、 千年同じ場所で、 千年同じ歌い方で、 歌い続けてきた。 メルの歌声は、 voidtower 派閥 BGM の vocalize 担当として、 戦場全体に、 千年祈りの音を、 静かに、 響かせていた。" },
  ],
  "R_戦場の救護 リサ": [
...
const IMG_CACHE_VERSION = '1.5.1bd';
