/* ============================================================
   Prismaera v1.5.1bm — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    // ===== S1C6 追加 (UR3、 巫女連邦リーリエ — 七座満つる) =====
    {
      ...
      desc: "巫女連邦リーリエの若き代表巫女、 二十一歳。 巫女連邦の継承血脈の最新の枝として、 観測者七座の第四席「約束」 (緑) に座する若き同胞。 母ヴィオレナ (七十歳前後の長老巫女) は約五十年前、 二十代後半で第四席候補に選ばれかけたが「私の娘が、 いずれ私の代わりに座る」 と告げて辞退した。 その約束を、 半世紀経って、 イリス自身の千年 (観測者として) として始める。 七色の灯篭の杖を持ち、 巫女連邦の祭祀継承を担う。",
      img: `${S1}/ur/iris.png`,
    },
    {
      ...
      desc: "巫女連邦リーリエの長老巫女、 七十歳前後。 紫銀の長髪に白銀が混じり、 紫水晶の深い瞳、 七色の二重玉を頂く杖。 約五十年前、 二十代後半で第四席候補に選ばれかけたが「私の娘が、 いずれ私の代わりに座る」 と告げて辞退、 巫女連邦の伝承継承を半生かけて担ってきた。 五十歳近くで直接娘イリスを授かり、 二十一年育てて、 ようやく第四席へと送り出す。 月影宮で交わした「私の半生は、 ここで娘を待ち、 育てる」 の誓いを、 半世紀経って完遂した。 巫女連邦の継承血脈を 数代に渡って語り継ぐ「千年語り」 の長老、 名は系譜上 千年単位の伝承を担う者の称号。",
...
const LORE_BY_KEY = {
  ...
  "UR_千年語り ヴィオレナ": [
    { title: "半世紀前の決断", body: "約五十年前のある夜、 ヴィオレナは月影宮に呼ばれた。 観測者七座の第四席「約束」 の候補として、 セラフィエル様が直々に招きに来てくださった夜だった。 二十代後半のヴィオレナは、 月光の下で深く礼をし、 静かに首を横に振った——「私は、 まだ、 地上にいたいのです」。 「私の娘が、 いずれ、 私の代わりにここへ来ます」。 その時、 ヴィオレナはまだ娘を産んでいなかった。 けれど、 巫女連邦の継承血脈の最後の枝が、 半世紀後にどんな娘を生むのか——その確信だけは、 既に、 彼女の胸の奥にあった。 半世紀前の自分との約束を、 五十歳近くで産んだ娘イリスの二十一歳の代に、 ようやく、 灯した。" },
    ...
    { title: "「娘に渡す」 半世紀の祈り", body: "ヴィオレナは半世紀、 巫女連邦の代表巫女として、 祭祀の継承を続けてきた。 約五十年前、 第四席候補に選ばれかけた夜、 千年伝承の巻物に、 自分の筆跡で、 こう書き加えた——「私の代に、 第四席は灯らない。 私はいずれ、 自分が直接産む娘の代に、 灯らせる」。 そして約三十年後、 五十歳近くで娘イリスを授かり、 二十一年育てた。 巻物の余白には、 ヴィオレナの 五十年の筆跡——大巫女ヴィーナを 育てた日、 ホムラに 娘の剣の師を 託した日、 イリスが 七歳で 「私自身の人生を 持っているのか」 と 問うた日——が、 静かに、 連なっている。 その全てが、 イリスの背中を、 半世紀分、 押し続けてきた。" },
    { title: "半世紀経った今夜の微笑み", body: "イリスが旅立つ朝、 ヴィオレナは中央神殿の聖堂前で、 静かに微笑んでいた。 半世紀待った母の、 最も静かな別れの作法。 セラフィエル様が「あなたの半生は、 私の千年と、 重なるのですね」 と告げてくださった、 約五十年前の夜の言葉が、 今、 形になっていた。 継承血脈の母は、 ここから先——「娘の母として」 ではなく、 「彼女自身として」 の老後を、 始める。 半世紀前、 第四席を辞退した夜には、 まだ見えていなかった、 もう一つの時間。 ヴィオレナは、 七十歳近い今夜、 ようやく、 自分のための祈祷を、 始める準備が、 整った。" },
  ],
  "UR_鳳神巫女 ホムラ": [
...
const IMG_CACHE_VERSION = '1.5.1bm';
