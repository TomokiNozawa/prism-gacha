/* ============================================================
   Prismaera v1.6.0r — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const STORY_ACT_INTROS = {
  ...
  's1c7': {
    ...
    '第一幕 — 黒月の覚醒':              '西の空に黒い月が昇る。 千年閉じ込めていた者が 戻ってくる。\n— プリズマ',
    '第二幕 — 全派閥総力戦':            '北から 南から 砂漠から 空から——千年の友が同じ戦場に立つ。\n— プリズマ',
    '第三幕 — 鏡像の再会':              'もう一人の影と もう一人の光が 戦場の中央で頷き合う夜。\n— プリズマ',
    '第四幕 — 共観の対話':              '塔の頂で 千年の対の存在と 初めて目を合わせる夜。\n— プリズマ',
    '第五幕 — 眠りに入る者':            '光を次の世代に託す日。 私は静かに眠りに就く。\n— プリズマ',
