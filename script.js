/* ============================================================
   Prismaera v1.6.0q — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    },
    {
      ...
      title: "虹霊界第七天の女神帝",
      caption: "すべての闇を\nこの火で照らしてやろう。",
      desc: "七天の最高天を統べる炎の女神帝、千年級の戦闘神。背に巨大な朱の鳳凰を従え、双大剣『日輪』『月輪』を振るう。影喰いとの戦いでは常に前衛に立つ。焔と虹を同時に纏う稀有な存在。千年前から龍帝アルテミスと並んで戦場に立ち続けてきた戦友で、互いの火と龍は古い夜から世界の前衛に並んでいる。焔舞ヒナカを『愛弟子』として認め、朱音の焔術も元を辿れば彼女に繋がる。",
    ...
    // ===== S1C6 追加 (UR3、 巫女連邦リーリエ — 七座満つる) =====
    {
      name: "イリス", season: 1, chapter: 's1c6',
      title: "巫女連邦の若き代表巫女、 第四席「約束」 着座者",
      caption: "私は、 約束を守るために、 生まれてきました。",
      desc: "巫女連邦リーリエの若き代表巫女、 二十一歳。 巫女連邦の継承血脈の最新の枝として、 観測者七座の第四席「約束」 (緑) に座する若き同胞。 母ヴィオレナ (巫女連邦の長老) は約五十年前、 二十代後半で第四席候補に選ばれかけたが「私の娘が、 いずれ私の代わりに座る」 と告げて辞退した。 その約束を、 半世紀経って、 イリス自身の千年 (観測者として) として始める。 七色の灯篭の杖を持ち、 巫女連邦の祭祀継承を担う。",
      img: `${S1}/ur/iris.png`,
    },
    {
      name: "千年語り ヴィオレナ", season: 1, chapter: 's1c6',
      title: "千年生きた巫女、 イリスの実母",
      caption: "あなたが帰る場所は、 いつでも、 ここですよ。",
      desc: "巫女連邦リーリエの長老巫女。 紫銀の長髪に白銀が混じり、 紫水晶の深い瞳、 七色の二重玉を頂く杖。 約五十年前、 二十代後半で第四席候補に選ばれかけたが「私の娘が、 いずれ私の代わりに座る」 と告げて辞退、 巫女連邦の伝承継承を半生かけて担ってきた。 晩年に直接娘イリスを授かり、 二十一年育てて、 ようやく第四席へと送り出す。 月影宮で交わした「私の半生は、 ここで娘を待ち、 育てる」 の誓いを、 半世紀経って完遂した。 巫女連邦の継承血脈を 数代に渡って語り継ぐ「千年語り」 の長老、 名は系譜上 長き伝承を担う者の称号。",
      img: `${S1}/ur/shrine_oracle.png`,
    },
    {
      name: "鳳神巫女 ホムラ", season: 1, chapter: 's1c6',
      title: "巫女連邦最強の戦巫女、 七座警護の頂点格",
      caption: "鳳神巫女は、 数代に渡り 七座入りを辞退してきた。 私の代も、 地上で警護を続ける。",
      desc: "巫女連邦リーリエの戦巫女最高峰、 二十七歳。 朱赤の髪を高く編み上げ、 七色の鳳の羽根を象嵌した薙刀を振るう。 巫女連邦の創建以来 数代続く鳳神巫女の血脈、 過去三代も第五席「連結」 候補に名が挙がるが「警護の継承職能は天上より地上に必要」 と全て辞退してきた。 イリスの剣の師、 同時に十五年共に育った姉のような存在。 焔帝ヒノオウ (UR、 千年級) の朱の鳳凰と 同じ祈りから生まれた 鳳神巫女の継承職能を担う。",
      img: `${S1}/ur/flame_shrine_warrior.png`,
    },
    // ===== S1C5 追加 (UR3、 黒月衆+地底市) =====
    {
    ...
    // ===== S1C4 追加 (UR2、 凍土の覇者+空挺の女皇) =====
    {
      ...
      desc: "氷霊王国ニーヴルの若き氷帝、 二十六歳。 古代氷霊の血を強く引く一族の若き継承者として、 同世代に類を見ない剣才で頂点に立った。 双の氷剣ニフルとヘイルで凍土を統べる。 アルテミスとの一騎打ちで引き分け、 互いを「戦友」 と認め合う山場の相手。 龍国の覇者と並ぶ「第三の覇者候補」 として黒月決戦の隣に立つ約束を交わす。",
    ...
    },
    {
      ...
      desc: "空挺城ゼノニアの神童女皇、 二十二。 機械工学と魔導を融合させた蒸気帝国の若き戴冠者。 蒸気魔導杖オラリオンと真鍮歯車の翼を従え、 観測者七座の手にすら届かぬ「もう一つの道」 を歩む。 アルテミスとの外交で「機械と魔導の融合」 が世界に何をもたらすかを示唆。 ゼピル学者を師に持つ。",
      img: `${S1}/ur/sky_empress.png`,
    },
    // ===== S1C7 追加 (UR5、 異界塔ザナド+共観の使徒+第七席候補) =====
    {
      name: "塔主 ザナディア", season: 1, chapter: 's1c7',
      title: "異界塔ザナドの千年塔主、 ヴォイドラ召喚者",
      caption: "千年、 待っていました。 あなたとの再会を。",
      desc: "千年前にヴォイドラを召喚し、 共に異界塔ザナドに閉じ込められた塔主。 千年級存在として、 リオラエル殿 (s1c5、 地底市) と同時代を生きた。 紫銀の長髪、 紫水晶の瞳、 七色の summoning-circle が刺繍された千年塔主の衣。 黒月決戦でプリズマとヴォイドラの対話を見届け、 千年の幽閉から解放される。",
      img: `${S1}/ur/void_tower_master.png`,
    },
    {
      name: "影使徒 ウンブリス", season: 1, chapter: 's1c7',
      title: "ヴォイドラ第一使徒、 シ・ロエン接触役",
      caption: "我が同胞よ。 影は、 一つではない。",
      desc: "千年閉じ込められた異界塔ザナドの中で 元から影として生まれたヴォイドラ第一使徒。 シ・ロエン (s1c5、 シオン分離後の影) とは別系統の影。 漆黒の単刃曲剣、 半割れの violet-edge 仮面。 シ・ロエンに「異界塔ザナドへの誘い」 を持ちかける役割。 シオン×シ・ロエン再会の前夜にもう一つの影として戦場に立つ、 黒月衆ノクトリアとは別陣営の voidtower 直属。",
      img: `${S1}/ur/umbra_apostle.png`,
    },
    {
      name: "黒月使徒 テネブラ", season: 1, chapter: 's1c7',
      title: "ヴォイドラ第二使徒、 ノクトリアと並ぶ千年盟友",
      caption: "千年待った夜が、 ようやく来た。",
      desc: "ヴォイドラ陣営の千年級女性使徒。 黒月衆の先代盟主と千年前に交わした「影の側の引き受け」 の盟約が、 現代のノクトリア (s1c5) の代まで黒月衆と異界塔ザナドの繋がりとして受け継がれてきた。 紫黒のロングヘア、 七つの inverted crescent 刺青、 双刃の void-halberd を構える。 千年閉じ込めの対価を覚悟しながらヴォイドラと共に閉じこもった同胞。",
  ...
  SSR: [
    ...
    },
    {
      ...
      desc: "紫竜王の三女にして、生まれながらの竜人。儀礼槍『紫雷』は彼女自身の竜気を解放する細身の竜気槍。姉が二人、 王位継承の余白に立つ第三王女として、戦場を己の居場所と決めた。龍帝アルテミスとは遠縁(竜の血筋)。リリムは実の従妹で、彼女を姉のように慕う。朱音とは酒の飲み仲間。",
    ...
    },
    {
      ...
      desc: "素顔も声も伏せた謎の聖騎士。王族暗殺の陰謀から主君を守るため、名と顔を捨てた。メイス『誓盾』と盾『裁罰』は神器級。無言の剛力が恐怖を呼ぶ。仮面の下の素顔を知る者は三人だけ——王族、イザベル、そしてセラフィエル。イザベルとは古い幼馴染。",
    ...
    // ===== S1C6 追加 (SSR4、 巫女連邦リーリエ — 七座満つる) =====
    {
      name: "大巫女 ヴィーナ", season: 1, chapter: 's1c6',
      title: "巫女連邦の長老格、 イリスの指導者",
      caption: "次の代に、 灯ります。",
      desc: "巫女連邦リーリエの大巫女、 三十代前半。 伝承の継承役で、 イリス (UR) の幼少期からの指導者。 銀髪に翡翠の先端、 翡翠の宝石の額飾り、 銀の杖を持つ。 巫女連邦祭祀の歴代の祈祷文を全て暗誦できる、 巫女連邦の生きた記憶。",
      img: `${S1}/ssr/shrine_elder.png`,
    },
    {
      name: "主祭 リアラ", season: 1, chapter: 's1c6',
      title: "七座儀式の儀典官、 月読み占星師",
      caption: "七座、 四つ満ちる。",
      desc: "巫女連邦リーリエの主祭、 二十代後半。 七色の星図を映す水晶玉を扱い、 観測者七座の儀式を進める儀典官。 紺青の長髪、 銀青の瞳、 星座と七色を縫い込んだ祭祀の衣。 イリスの七座着座儀式を、 巫女連邦の歴史で稀な儀典として執り行った。",
      img: `${S1}/ssr/moon_chief_priestess.png`,
    },
    {
      name: "楽巫女 イオナ", season: 1, chapter: 's1c6',
      title: "巫女連邦の神楽祭祀、 七色合唱の指揮者",
      caption: "七色の音が、 七座を呼ぶのです。",
      desc: "巫女連邦リーリエの楽巫女、 二十代前半。 七弦の神聖な琴 (七色対応) を操り、 灯篭祭の神楽演奏を司る。 金髪に七色のハイライト、 ハシバミ色の瞳、 銀金の祭祀の衣。 七座儀式の祭楽を担当、 巫女連邦祭祀の音色を継承する一族。",
      img: `${S1}/ssr/shrine_musician.png`,
    },
    {
      name: "双子巫女姉 ノエラ", season: 1, chapter: 's1c6',
      title: "イリスの幼馴染、 双子の姉",
      caption: "妹と一緒なら、 私は強くいられます。",
      desc: "巫女連邦リーリエの双子巫女姉、 二十一歳 (イリスと同年代)。 淡いラベンダー色の長髪、 紫の瞳、 緑のリボンを編み込んだ髪型。 双子妹アシナと対の構図、 イリスの幼馴染としても支え合ってきた。 静かで保護的な性格、 妹の前では揺るがない。",
      img: `${S1}/ssr/twin_priestess_elder_noera.png`,
    },
    ...
    },
    {
      ...
      caption: "(沈黙、 一礼)",
      desc: "グレイル氷帝の剣師、 二十六-二十七歳の見た目。 古代氷霊の血を強く引く一族で老化が遅く、 実年齢は本人も明かさない (グレイルの父——先代氷帝——の代から剣師を務めてきた)。 双の氷剣ヘルファング (ニフルとヘイルの先代型) の使い手。 寡黙、 弟子グレイルへの信頼は揺らがない。",
    ...
    // ===== S1C7 追加 (SSR9、 9派閥旗手 各1体ずつ) =====
    {
      name: "白焔聖騎士団長 オーレン", season: 1, chapter: 's1c7',
      title: "白焔教会騎士団長、 教会陣営の総大将",
      caption: "教会の盾は、 民を守るためにある。",
      desc: "白焔教会の聖騎士団長、 二十六-二十七。 教会陣営の総指揮を担う。 イザベル (s1c2 UR 波紋の聖女) とラナス (s1c2 SR 教会騎士) を率い、 黒月決戦で堕者剣聖ガルヴィン (s1c5 SSR) と対峙する。 白い飾旗のような聖騎士の格式、 白炎のロングソードを構えて静かに前進する。",
      img: `${S1}/ssr/church_captain.png`,
    },
    {
      name: "アクアシス海神官 ナイアス", season: 1, chapter: 's1c7',
      title: "深海女王配下の海神官、 海陣営戦術指揮",
      caption: "海の祈りを、 戦の指揮にも織り込みます。",
      desc: "海淵都市アクアシスの海神官、 二十五-二十六。 ネプテア (s1c2 UR 深海女王) の戦術指揮役、 深海と陸の境界で海陣営を導く。 双の三叉槍、 流れる水紋の刺青。 海中射撃と海獣使いの統括、 海陣営の総合戦力を指揮する。",
      img: `${S1}/ssr/aquasis_high_priest.png`,
    },
    {
      name: "紅玉旗艦砲手長 マロン", season: 1, chapter: 's1c7',
      title: "紅玉海賊団の戦闘特化、 シャンティの戦友",
      caption: "撃つぞ! 副長は航海頼んだ!",
      desc: "紅玉海賊団の旗艦砲手長、 二十七-二十八。 シャンティ (s1c2 UR 紅玉海賊団船長) の戦闘の戦友、 副長ケイレブ (s1c2 SSR) の航海能力と独立した「砲撃指揮」 特化。 brass-gold ライフル砲、 三角帽の紅羽飾り、 黒バンダナで前線を撃つ。",
      img: `${S1}/ssr/crimson_gunner.png`,
    },
    {
    ...
    {
      name: "氷霊魔導長 ノエル", season: 1, chapter: 's1c7',
      title: "ニーヴル氷魔法トップ、 グレイル魔法側補佐",
      caption: "氷の理を、 戦場の力学に織り込む。",
      desc: "氷霊王国ニーヴルの氷魔導長、 二十六-二十七。 グレイル (s1c4 UR 氷帝) の魔法側補佐として、 リオネ (s1c4 SSR 氷塔の聖騎士=剣) とハグル (s1c4 SSR 北方剣聖=師) と独立した新領域。 氷の単独魔導士の頂点、 氷晶の杖と銀-青のロブを持つ。",
      img: `${S1}/ssr/frost_archmage.png`,
    },
    {
      name: "空挺艦隊長 メリディア", season: 1, chapter: 's1c7',
      title: "空挺城ゼノニア艦隊司令、 ヴァーレ女皇配下",
      caption: "全艦、 砲撃用意! 進路は黒月決戦場へ!",
      desc: "空挺城ゼノニアの艦隊司令、 二十六-二十七。 ヴァーレ (s1c4 UR 空挺女皇) 配下の軍事側補佐、 ガリオン (s1c4 SSR 空挺城総監=都市行政) と独立した「艦隊司令」。 brass-gold 艦長帽、 蒸気剣、 真鍮の双眼鏡を構える艦隊指揮官。",
      img: `${S1}/ssr/sky_fleet_admiral.png`,
    },
    {
      name: "銀霜神官長 ヴィルニル", season: 1, chapter: 's1c7',
      title: "雪月神殿最高位、 ノヴァ王の精神的支柱",
      caption: "銀霜の月よ、 王の道を照らせ。",
      desc: "銀霜王国の雪月神殿最高位、 二十七-二十八。 ノヴァ (s1c5 SSR 銀霜王) の精神的支柱、 月夜祭司アスター (s1c5 SR) の上位、 銀霜の宗教面の頂点。 銀月の杖、 月の刺繍が入ったロブで、 黒月決戦中も雪月神殿で祈祷を捧げ続ける支援役。",
      img: `${S1}/ssr/silver_high_priest.png`,
    },
    {
      name: "巫女連邦軍師 セイラン", season: 1, chapter: 's1c7',
      title: "巫女連邦軍部代表、 戦巫女と独立した戦略担当",
      caption: "戦場の図を、 七色に塗り直しましょう。",
      desc: "巫女連邦リーリエの軍師、 二十五-二十六。 ホムラ (s1c6 UR 鳳神巫女=戦巫女頂点) と独立した「戦略担当」 として全派閥連携の中枢を担う。 jade-and-bronze の戦略服、 七色の作戦扇子を開いて指揮を行う。 黒月決戦の全派閥戦略を一冊の絵巻に集約する役。",
      img: `${S1}/ssr/shrines_strategist.png`,
    },
    {
      name: "異界塔執行官 オブスクル", season: 1, chapter: 's1c7',
      title: "ザナディア配下、 異界塔ザナド戦士団総大将",
      caption: "塔の意志を、 剣で執行する。",
      desc: "異界塔ザナドの執行官、 二十七-二十八。 ザナディア (UR 塔主) 配下の戦術指揮、 voidtower 戦士団の総大将。 voidtower 軍服、 broken-crescent 紋章、 violet-black ロングソード。 ノクトリア (s1c5 黒月衆盟主) と並ぶ「敵側 SSR 旗手」 の格、 黒月決戦の主敵指揮官として全派閥と対峙する。",
      img: `${S1}/ssr/void_executor.png`,
    },
  ],
  SR: [
    {
    ...
    {
      name: "月読み祭司 オリオン", season: 1, chapter: 's1c6',
      title: "巫女連邦の天文・暦の祭司",
    ...
    },
    {
      ...
      title: "鳳神巫女ホムラの直属、 神殿警護隊長",
      caption: "ホムラ様の薙刀の隣で、 ずっと、 立ち続けます。",
      desc: "巫女連邦リーリエの神殿護衛戦士、 二十三歳。 ホムラ (UR) の直属、 朱赤の頭巾と漆赤の槍を構える。 鳳の羽根の小肩当て、 朱の祭祀戦闘の衣。 灯篭祭と七座儀式の警護隊長として、 神殿の安全を担う。",
      img: `${S1}/sr/shrine_guard.png`,
    },
    {
      name: "七座楽人 ハルナ", season: 1, chapter: 's1c6',
      title: "公式儀式の弦楽奏者",
      caption: "七色の音は、 世代を経ても、 同じです。",
      desc: "巫女連邦リーリエの七座楽人、 二十四歳。 銀の長髪を低く束ね、 七弦の竪琴を奏でる。 銀金の宮廷楽人の衣、 落ち着いた銀灰の瞳。 公式儀式の祭楽担当、 楽巫女イオナ (SSR) と並んで七座儀式の音楽を支える。",
      img: `${S1}/sr/shrine_minstrel.png`,
    },
    {
      name: "灯篭職人長 コノエ", season: 1, chapter: 's1c6',
      title: "灯篭祭の七色灯篭を継ぐ職人頭",
      caption: "灯篭は、 灯し直すから、 灯篭なのです。",
      desc: "巫女連邦リーリエの灯篭職人長、 三十八歳。 焦茶の高結びの髪に七色の絹リボン、 ハシバミ色の瞳、 工房用の作業衣。 巫女連邦祭祀の七色紙灯篭を製作する一族の頭。 「灯篭が消えた村跡」 にも月一で巡礼に行き、 世代を経ても灯し直す祈りを継ぐ。",
      img: `${S1}/sr/lantern_master.png`,
    },
    {
      name: "医療巫女 メア", season: 1, chapter: 's1c6',
      title: "巫女連邦の癒し手",
      caption: "祈りも薬も、 同じ温度で渡します。",
      desc: "巫女連邦リーリエの医療巫女、 二十五歳。 淡桃色の髪に七色のハイライト、 桃色の瞳、 治癒の薬草を縫い込んだ祭祀の衣。 灯篭祭の医療所を運営、 鳳神巫女の戦士たちの怪我も預かる、 巫女連邦の守り手。",
      img: `${S1}/sr/shrine_healer.png`,
    },
    {
      name: "高巫女見習い カヤ", season: 1, chapter: 's1c6',
      title: "大巫女ヴィーナの直弟子",
      caption: "巫女連邦の伝承を、 暗誦できるようになります。",
      desc: "巫女連邦リーリエの高巫女見習い、 十八歳。 翡翠銀の長髪を片サイドポニーで結び、 真剣な翡翠の瞳。 大巫女ヴィーナ (SSR) の直弟子として、 巫女連邦祭祀の継承を学ぶ若き候補。 巫女連邦次世代候補の代表格。",
      img: `${S1}/sr/shrine_high_apprentice.png`,
    },
    ...
    },
    {
      ...
      caption: "ご無事でー!",
      desc: "ゼノニア機械工房の整備士、 十八-十九。 朱色ショートカットに溌剌とした若き機械工女。 大型スパナと軽機関銃を扱う。 ハーニア親方を師に持ち、 機械への深い愛情を燃やす。 ジン機関士の幼馴染。",
    ...
    // ===== S1C7 追加 (SR10、 派閥戦士+異界塔ザナド戦士団) =====
    {
      name: "教会の盾 リーラ", season: 1, chapter: 's1c7',
      title: "若き白焔教会騎士、 ラナスの後輩",
      caption: "盾は、 倒れる人を守るためにある。",
      desc: "白焔教会の若き盾を担う騎士、 二十一-二十二。 ラナス (s1c2 SR 教会騎士) の後輩、 防衛戦の要として教会陣営を支える。 大型の白タワーシールドと短剣を構え、 戦場救護担当のリサ (R) を守りながら戦う。",
      img: `${S1}/sr/church_shieldmaiden.png`,
    },
    {
      name: "海淵射手 シャラ", season: 1, chapter: 's1c7',
      title: "アクアシス長弓兵、 海中射撃の達人",
      caption: "波の中の標的、 射程に入った。",
      desc: "海淵都市アクアシスの長弓兵、 二十一-二十二。 海中射撃の特殊技を持つ。 珊瑚-真珠の長弓を引き、 海陣営の遠距離戦力。 既存アクアシス SR (魔術系・巫女系) と完全独立の弓兵領域。",
      img: `${S1}/sr/aquasis_archer.png`,
    },
    {
      name: "古龍鎧の戦士 ガロン", season: 1, chapter: 's1c7',
      title: "サハール部族の若き戦士、 グランの弟子",
      caption: "古龍の血が、 私の刃を導く。",
      desc: "古龍砂漠サハールの若き戦士、 二十一-二十二。 グラン (s1c3 SR 砂牙の剣聖) の弟子、 古龍鱗の鎧で「直系の血」 を視覚化。 古龍鱗の単刃曲剣を構え、 砂漠陣営の前衛として戦う。",
      img: `${S1}/sr/dragon_warrior.png`,
    },
    {
      name: "氷塔の魔導士 セレスタ", season: 1, chapter: 's1c7',
      title: "ニーヴル氷魔法使い、 ユーリス予言の補佐",
      caption: "氷晶の理を、 戦場に解き放つ。",
      desc: "氷霊王国ニーヴルの若き氷魔導士、 二十一-二十二。 ユーリス (s1c4 UR 氷霜の巫女=予言) の若き補佐、 ノエル (SSR 魔導長) の弟子格。 銀-青のロブと氷晶の杖、 氷魔法の若き使い手。",
      img: `${S1}/sr/frost_mage.png`,
    },
    {
      name: "空挺機械兵 リガン", season: 1, chapter: 's1c7',
      title: "ゼノニア機械兵、 真鍮歯車武装",
      caption: "蒸気の銃口、 火を吹くぜ!",
      desc: "空挺城ゼノニアの若き機械兵、 二十一-二十二。 既存ゼノニア SR (整備士・砲手・機関士) より戦闘特化、 蒸気ライフル + 蒸気手榴弾の機械兵。 ガリオン (SSR 総監) 配下の戦闘部隊。",
      img: `${S1}/sr/sky_mech_soldier.png`,
    },
    {
      name: "銀霜の若騎士 ライオン", season: 1, chapter: 's1c7',
      title: "セレンの後輩、 月夜祭警護",
      caption: "セレン先輩、 私が王宮を守ります!",
      desc: "銀霜王国の若き騎士、 二十一-二十二。 セレン (s1c5 SR 銀霜近衛) の後輩、 月夜祭の警護役を担う。 銀-月-青の鎧、 銀-青のロングソード。 ノヴァ王 (SSR) の若き親衛として黒月決戦の前線に立つ。",
      img: `${S1}/sr/silver_knight.png`,
    },
    {
      name: "異界塔の闇衛 ノクサル", season: 1, chapter: 's1c7',
      title: "異界塔の若き闇兵、 影の鎧",
      caption: "塔の意志を、 我が刃で守る。",
      desc: "異界塔ザナドの若き闇衛、 二十一-二十二。 オブスクル (SSR 執行官) 配下の戦闘部隊、 broken-crescent 紋章の void-black 鎧、 voidtower の前線兵。 黒月決戦で全派閥と戦う。",
      img: `${S1}/sr/void_dark_guard.png`,
    },
    {
      name: "異界塔の魔導兵 アビス", season: 1, chapter: 's1c7',
      title: "異界塔の若き魔導士、 闇の咒術",
      caption: "影の咒術を、 解き放つ。",
      desc: "異界塔ザナドの若き闇魔導士、 二十一-二十二。 broken-crescent 刺繍の void mage robe、 obsidian の void mage staff。 闇の咒術担当、 凍土陣営との魔法戦の前線。",
      img: `${S1}/sr/void_abyss_mage.png`,
    },
    {
      name: "異界塔の斥候 グリム", season: 1, chapter: 's1c7',
      title: "影の中を歩く偵察兵",
      caption: "影は、 私の足跡を消してくれる。",
      desc: "異界塔ザナドの若き斥候、 二十-二十一。 影の中を歩く偵察、 戦線の情報伝達役。 void-black scout 装、 void-black 双短剣を逆手で構える両性的な存在。 シ・ロエン接触の前哨偵察を担う。",
      img: `${S1}/sr/void_scout.png`,
    },
    {
  ...
  R: [
    ...
    // ===== S1C6 追加 (R6、 巫女連邦リーリエ — 七座満つる) =====
    {
      name: "巫女見習い アヤメ", season: 1, chapter: 's1c6',
      title: "巫女連邦の見習い、 灯篭祭の補助役",
      caption: "灯篭、 落とさないようにしますね。",
      desc: "巫女連邦リーリエの見習い、 十六歳。 翡翠色の短髪に緑のリボン、 明るい緑の瞳。 灯篭祭の蝋燭灯篭を運ぶ補助役。",
      img: `${S1}/r/shrine_novice_a.png`,
    },
    {
      name: "巫女見習い スズ", season: 1, chapter: 's1c6',
      title: "巫女連邦の見習い、 鈴鳴らし役",
      caption: "(竹鈴の音、 ちりん。)",
      desc: "巫女連邦リーリエの見習い、 十五歳。 銀金の短髪に小さな三つ編み、 金茶の瞳。 灯篭祭の鈴鳴らし役、 元気な性格。",
      img: `${S1}/r/shrine_novice_b.png`,
    },
    {
      name: "巫女見習い ハナ", season: 1, chapter: 's1c6',
      title: "巫女連邦の見習い、 散華役",
      caption: "桃の花びら、 散らしますね。",
      desc: "巫女連邦リーリエの見習い、 十七歳。 淡桃色の長髪を双子おさげ、 桃紫の瞳。 灯篭祭の散華 (花びらを撒く) 役、 物静かな性格。",
      img: `${S1}/r/shrine_novice_c.png`,
    },
    {
      name: "巫女見習い ユウ", season: 1, chapter: 's1c6',
      title: "巫女連邦の見習い、 清掃役",
      caption: "神殿、 きれいにしておきます。",
      desc: "巫女連邦リーリエの見習い、 十六歳。 淡ラベンダーの短髪、 淡青の瞳。 神殿の階段の清掃を担当、 寡黙だが丁寧な性格。",
      img: `${S1}/r/shrine_novice_d.png`,
    },
    {
      name: "楽人見習い ハジメ", season: 1, chapter: 's1c6',
      title: "巫女連邦の楽人見習い、 木製の笛を学ぶ少年",
      caption: "(音、 まだ震える)",
      desc: "巫女連邦リーリエの楽人見習い、 十六歳。 銀の短髪、 銀灰の瞳。 木製の縦笛を学ぶ少年、 楽巫女イオナ (SSR) の弟子の一人。",
      img: `${S1}/r/musician_novice_hajime.png`,
    },
    {
      name: "灯篭職人見習い リル", season: 1, chapter: 's1c6',
      title: "巫女連邦の灯篭職人見習い、 紙竹を扱う少女",
      caption: "灯篭、 自分で作れるようになります。",
      desc: "巫女連邦リーリエの灯篭職人見習い、 十五歳。 焦茶の短髪に七色の糸の三つ編み、 ハシバミ色の瞳。 コノエ (SR、 灯篭職人長) の弟子、 灯篭祭の灯篭を継ぐ若き手。",
      img: `${S1}/r/lantern_novice.png`,
    },
    ...
    // ===== S1C7 追加 (R5、 異界塔の小兵+各派閥の名もなき戦士) =====
    {
      name: "異界塔の伝令 ヴィタ", season: 1, chapter: 's1c7',
      title: "異界塔ザナドの若き伝令、 影の翼で空を飛ぶ",
      caption: "塔の意、 全戦線へ届けます!",
      desc: "異界塔ザナドの若き伝令、 十八-十九歳。 影の翼で空を飛び、 voidtower 戦士団の各戦線に塔主の意志を届ける伝令役。 broken-crescent 旗、 obsidian 巻物、 影の小翼で機動する両性的な存在。",
      img: `${S1}/r/void_messenger.png`,
    },
    {
      name: "異界塔の鍛冶 ザイ", season: 1, chapter: 's1c7',
      title: "異界塔の若き鍛冶、 闇の武具を作る",
      caption: "刃よ、 影を切り裂け……。",
      desc: "異界塔ザナドの若き鍛冶、 十八-十九歳。 obsidian の anvil で void 武具を作る、 千年閉じこもった forges を再び動かす一人。 短く messy な midnight-black hair、 violet 焔のキャラクター性。",
      img: `${S1}/r/void_smith.png`,
    },
    {
      name: "異界塔の歌手 メル", season: 1, chapter: 's1c7',
      title: "異界塔の若き歌手、 闇の祈祷を歌う",
      caption: "千年の歌を、 これからも、 歌い続けます。",
      desc: "異界塔ザナドの若き歌手、 十八-十九歳。 void singer として千年閉じ込められた塔の祈祷歌を歌い続ける。 deep-violet ドレス、 violet cithern を抱える夢のような若き歌姫。 メルの歌声が voidtower 派閥 BGM の vocalize 担当。",
      img: `${S1}/r/void_singer.png`,
    },
    {
      name: "戦場の救護 リサ", season: 1, chapter: 's1c7',
      title: "教会の若き救護担当、 戦場で負傷者を助ける",
      caption: "立てますか? 私が、 ここにいます。",
      desc: "白焔教会の若き救護担当、 十八-十九歳。 戦場で負傷者を助ける救護役、 healing wand と bandages で前線兵を治す。 教会陣営の戦場救護要員、 オーレン (SSR 団長) 配下のサポート系。",
      img: `${S1}/r/battlefield_medic.png`,
    },
    {
      name: "戦場の伝令 タイ", season: 1, chapter: 's1c7',
      title: "第七天の若き伝令、 全派閥間を駆ける",
      caption: "全派閥の旗、 全部見届けてやる!",
      desc: "第七天の若き伝令、 十八-十九歳。 全派閥間を駆けて連絡を担う、 派閥連携の象徴。 七色の旗印、 短い茶髪と元気な性格。 黒月決戦中、 全派閥の連絡網を一人で繋ぐ。",
      img: `${S1}/r/battlefield_runner.png`,
    },
  ],
};
...
const LORE_BY_KEY = {
  ...
  "UR_焔帝 ヒノオウ": [
    ...
    { title: "アルテミスとの夜", body: "アルテミスとの『背を預ける戦場』——千年前、影喰いとの初戦の夜は、過去最大の群れだった。二人は互いの背に自分の命を丸ごと預け、九時間戦い続けた。戦が終わった後、ヒノオウは一言、『お前がいて助かった』と言った。覇王アルテミスは珍しく固まり、やがて『こちらのセリフだ』と返した。それから千年、戦の気配を嗅げば、次も二人はきっと同じ場所に立つ。言葉にしない約束が、そこにはある。" },
  ...
  "SSR_竜爵 ヴィル": [
    { title: "姉への手紙", body: "王位を継ぐ姉へ、ヴィルは月に一度手紙を書く。内容は『酒は控えろ』『朝餉を食え』『過労なきよう』——末妹のような小言ばかり。姉は毎回笑って読み、最後に『ヴィルもお元気で』と書いた手紙を返す。王宮では『冷徹な竜姫』と呼ばれるヴィルが、姉の前では永遠に『末妹』であることを、ヴィル自身は誰にも明かさない。" },
  ...
  "SSR_仮面騎士 シオン": [
    ...
    { title: "誓いの相手", body: "誓盾と裁罰——その神器を授かった日、シオンは神殿で五つの誓いを立てた。『主君を守る』『仲間を守る』『弱者を守る』『真実を守る』——四つは公の誓い。だが五つ目は、誰にも告げていない。『あの子の幼い笑顔を、今度こそ守る』——イザベルが幼い頃、ある事件で守れなかった姉を、シオンは今もって自分の罪としている。仮面はその罪を覆い隠すためでもある。 s1c5 黒月決戦の夜、 この五つ目の誓いは イザベルの姉一人だけでなく、 銀霜の街娘・雪月神殿の見習い・地底市のシエル・そしてイザベル自身——光の側の全ての幼い笑顔へ 静かに拡張された。" },
  ...
  "SSR_空挺城総監 ガリオン": [
    { title: "空挺城の鉄則", body: "ガリオンは二十七歳、 ヴァーレ女皇即位前から空挺城の総監を務めている。 彼の鉄則は三つ——『一、 真鍮を錆びさせない。 二、 民の手を冷やさない。 三、 女皇の言葉を歪めない』。 父も祖父も総監だった、 ゼノニア最古の家系の三代目。 ヴァーレ女皇が即位した日、 ガリオンは深く礼をして告げた——『陛下。 私は陛下の盾でも矛でもありません。 真鍮の蝶番です。 開けたい扉と、 閉じたい扉を、 陛下に従って動かします』。" },
  ...
  "SSR_北方剣聖 ハグル": [
    { title: "グレイルの剣師として", body: "ハグルは見た目こそ二十六、 七歳だが、 古代氷霊の血を強く引く一族で老化が遅く、 実年齢は本人も明かさない。 グレイルの父——先代氷帝——の代から剣師を務めている。 グレイルが八歳で初めて木剣を握った日、 ハグルは静かに告げた——『若様。 双剣は、 二つの心です。 振るう前に、 二つの心を並べてください』。 グレイルが二十六年、 双剣を磨き続けた根底には、 ハグルの最初のこの一言がある。" },
  ...
  "SSR_空挺城首席学者 ゼピル": [
    { title: "空挺城の首席学者", body: "ゼピルは二十八歳。 ヴァーレ女皇即位前から空挺城の首席学者を務める、 ゼノニア機械文明の知の中枢。 真鍮歯車の設計図、 蒸気機関の制御理論、 空挺戦の戦術——全てゼピルの頭の中にある。 だが彼の最も大切な研究テーマは『機械文明と人の心の境界』。 機械が人の心を超えてはいけない、 が彼の信念。 ヴァーレ女皇即位の朝、 ゼピルは『陛下、 機械文明は心の延長です。 心を超えてはいけません』 と告げた。" },
  ...
  "SSR_真鍮の女将 ハーニア": [
    { title: "真鍮の女将、 工房の母", body: "ハーニアは二十五歳、 空挺城ゼノニアの大工房の親方。 真鍮ハンマーを担いだ姿で『お嬢さま、 こっち!』 と女皇を呼ぶのは、 ゼノニアでハーニアだけ。 ヴァーレが幼少期から工房に通い、 ハーニアの背中を見て育った。 ハーニアにとって、 ヴァーレは『工房の娘』、 ピットとピピは『工房の孫』、 ベルとヴィンとジンは『工房の弟妹』 だ。 真鍮ハンマーの音が、 ハーニアの母性の鼓動なのだ。" },
  ...
  // ===== S1C4 SR 凸秘話 =====
  "SR_氷牙の戦士 イズン": [
    { title: "氷牙の戦士、 アルクの兄貴分", body: "イズンは十九歳、 凍土の若き双斧使い。 雪原村に時々顔を出して、 アルクら子供たちに氷の握り方を教える。 アルクが『イズン兄!』 と呼ぶたび、 イズンは少し照れた顔をする——『俺の弟は、 おまえじゃないけどな』。 でもイズンは、 アルクが彫った小さな氷の彫像を、 自分の家に飾っている。 子供の真っ直ぐな憧れは、 戦士の重い双斧を、 ほんの少し軽くしてくれる。" },
  ...
  "SR_凍土の狩人 シエラ": [
    { title: "凍土の狩人、 雪豹を追う", body: "シエラは二十一歳、 ニーヴル雪原村の若き狩人。 氷の弓を背負い、 雪豹を一矢で仕留める。 父も祖父も狩人だった、 雪原村最古の狩人家系の三代目。 シエラの狩りの流儀は『静寂』——足音、 息、 心拍、 全てを雪原に預けてから、 一矢を放つ。 雪原の朝、 シエラの背中は、 風の一部のように溶ける。" },
  ...
  "UR_黒月の盟主 ノクトリア": [
    ...
    { title: "杖の三日月、 母から", body: "黒の杖を頂く三日月のオーブ——あれは、 ノクトリアの母から受け継いだもの。 母は黒月衆の前代盟主で、 三日月病 (千年に一度の異界病) で逝った。 「次に三日月を受け取った者が、 ヴォイドラの声を聴く」——母の遺言通り、 ノクトリアは継承の儀の夜に初めて声を聞いた。 杖を握るたび、 母の指の温度を思い出す。 母の代では、 こんなに重い杖ではなかったかもしれない。" },
    ...
    { title: "S1C7 — 黒月決戦への祈り", body: "黒月決戦の夜、 ノクトリアはヴォイドラと プリズマの対話の場に立つ。 「戦いではなく、 合意による決着を」——ノクトリアの願いがヴォイドラに届くか、 試される瞬間。 ヴォイドラが「私の影として認める」 と告げられたなら、 ノクトリアは杖を下ろす。 母の遺品の杖を、 ようやく地に置く儀式。 「お母様、 私は代弁者の役目を、 ようやく終えます」——その夜、 三日月の刺青が静かに薄れる。" },
  ],
  "UR_地底市の母 リオラエル": [
  ...
  // ===== S1C6 凸秘話 (巫女連邦リーリエ — 七座満つる、 計44本: UR3×4 + SSR4×3 + SR7×2 + R6×1) =====
  "UR_イリス": [
    { title: "継承血脈の自覚", body: "イリスは物心ついた頃から、 母ヴィオレナに「お前は約束を守るために生まれた」 と告げられて育った。 半世紀前、 母が第四席を辞退した夜の話を、 何度も聞かされた。 七歳の冬、 イリスは初めて母に問うた——「私は、 私自身の人生を、 持っているのですか?」。 母は、 静かに微笑み、 こう答えた——「その問いを、 自分で見つけることが、 あなたの千年です」。 イリスは、 その答えを、 二十一年抱えて生きてきた。 そして、 セラフィエル様の招待状を受け取った夜、 ようやく、 答えの最初の一頁を、 自分の手で開いた。" },
    { title: "セラフィエル様との初対面", body: "灯篭祭の夜、 街路の上空からセラフィエル様が降りてこられた瞬間、 イリスは膝をつかなかった。 母から「観測者七座は、 同列の同胞だ。 仰ぎ見る相手ではない」 と教えられていたから。 セラフィエル様は、 真っ直ぐにイリスの眼を見て、 「面を上げよ、 イリス。 あなたは、 既に、 私と同じ高さに立つ者なのです」 と告げた。 イリスは、 その時、 継承血脈の意味が——「同等の存在として迎えられる準備」 だったのだと、 初めて理解した。 半世紀待った母の祈りは、 イリス自身の千年 (観測者として) の入口だった。" },
    { title: "「私自身の千年」 の始まり", body: "月夜の祈祷の塔で、 イリスはセラフィエル様に告白した——「自分が母の半生の延長線上にしか存在していないのではないか」 と。 セラフィエル様は、 千年前ご自身がプリズマ様に「最初の羽」 として生まれた夜の話をしてくださった。 「翼を一枚、 静かにたたんだ夜があった。 それは、 『私はまだ飛べる』 という、 最も静かな返事でした」。 イリスは、 その夜、 自分の中で、 母の半生と並ぶ「もう一つの千年」 (観測者としての千年) が、 静かに灯り始めるのを感じた。 母の祈りの続きではなく、 自分自身の祈りの始まり。" },
    { title: "七座の同胞として", body: "月影宮の七座儀式の夜、 イリスは第四席に腰を下ろした瞬間、 卓の七つの同心円のうち緑の環が、 千年ぶりに灯った。 三柱は、 イリスを「妹」 ではなく「同胞」 として迎えた。 イリスは、 観測者の最初の言葉として、 こう告げた——「『違っていても、 同じ目的を持つ仲間でいられる』」。 カグヤ様は微笑み、 ノクス様は頷き、 セラフィエル様は翼を半分広げた。 そして、 ノクス様が静かに呟いた——「これでも、 足りない」。 イリスは、 その夜、 自分が「迎える側」 になる千年 (観測者の千年) が、 既に、 始まっていることを知った。" },
  ],
  "UR_千年語り ヴィオレナ": [
    { title: "半世紀前の決断", body: "約五十年前のある夜、 ヴィオレナは月影宮に呼ばれた。 観測者七座の第四席「約束」 の候補として、 セラフィエル様が直々に招きに来てくださった夜だった。 二十代後半のヴィオレナは、 月光の下で深く礼をし、 静かに首を横に振った——「私は、 まだ、 地上にいたいのです」。 「私の娘が、 いずれ、 私の代わりにここへ来ます」。 その時、 ヴィオレナはまだ娘を産んでいなかった。 けれど、 巫女連邦の継承血脈の最後の枝が、 半世紀後にどんな娘を生むのか——その確信だけは、 既に、 彼女の胸の奥にあった。 半世紀前の自分との約束を、 晩年に産んだ娘イリスの二十一歳の代に、 ようやく、 灯した。" },
    { title: "母から受け取った巻物", body: "ヴィオレナが第四席候補に選ばれかけた夜の数年前、 母 (= ヴィオレナの実母、 巫女連邦の前代表巫女) が病で逝った。 母は最後に、 千年伝承の巻物の鍵を、 ヴィオレナに渡した。 「お前の代も、 灯らないかもしれない。 灯らなかったら、 次の代に渡せ。 それだけでよい」 — 母の最後の言葉。 ヴィオレナは巻物を継いでから初めて読み、 母も、 母の母も、 そのまた母も、 同じ「次の代に灯る」 を 数代分、 書き継いできたことを知った。 「**人間世代の継承では永遠に灯らないかもしれない**」 — その夜、 ヴィオレナは、 自分の代に「いずれ、 私が直接産む娘の代に、 灯らせる」 と書き加える決心を、 静かに固めた。" },
    { title: "「娘に渡す」 半世紀の祈り", body: "ヴィオレナは半世紀、 巫女連邦の代表巫女として、 祭祀の継承を続けてきた。 約五十年前、 第四席候補に選ばれかけた夜、 千年伝承の巻物に、 自分の筆跡で、 こう書き加えた——「私の代に、 第四席は灯らない。 私はいずれ、 自分が直接産む娘の代に、 灯らせる」。 そして長い祭祀の歳月を経て、 晩年に娘イリスを授かり、 二十一年育てた。 巻物の余白には、 ヴィオレナの 五十年の筆跡——大巫女ヴィーナを 育てた日、 ホムラに 娘の剣の師を 託した日、 イリスが 七歳で 「私自身の人生を 持っているのか」 と 問うた日——が、 静かに、 連なっている。 その全てが、 イリスの背中を、 半世紀分、 押し続けてきた。" },
    { title: "半世紀経った今夜の微笑み", body: "イリスが旅立つ朝、 ヴィオレナは中央神殿の聖堂前で、 静かに微笑んでいた。 半世紀待った母の、 最も静かな別れの作法。 セラフィエル様が「あなたの半生は、 私の千年と、 重なるのですね」 と告げてくださった、 約五十年前の夜の言葉が、 今、 形になっていた。 継承血脈の母は、 ここから先——「娘の母として」 ではなく、 「彼女自身として」 の老後を、 始める。 半世紀前、 第四席を辞退した夜には、 まだ見えていなかった、 もう一つの時間。 ヴィオレナは長い半生を経た今夜、 ようやく、 自分のための祈祷を始める準備が整った。" },
  ],
  "UR_鳳神巫女 ホムラ": [
    { title: "鳳神巫女の継承職能", body: "鳳神巫女の血脈は、 巫女連邦の創建以来、 数代続いている。 ホムラの祖母も、 母も、 そのまた祖母も——皆、 七座警護の頂点格として、 巫女連邦の神殿を守ってきた。 ホムラは二十七で、 既に祖母三代分の鳳神薙刀の技を継承した若き戦巫女。 「警護の継承職能は、 天上より地上に必要だ」。 これが、 鳳神巫女の代々の口伝。 ホムラはこの口伝を、 自分の墓の銘にしようと決めている。 朱の鳳凰の系譜は、 焔帝ヒノオウ様 (千年級) の朱の鳳凰と、 同じ祈りから生まれた——けれど、 それはホムラもまだ、 完全には知らない。" },
    { title: "イリスの剣の師として十五年", body: "イリスが六歳の時、 母ヴィオレナがホムラに告げた——「この娘の剣の師を、 お願いします」。 当時十二歳だったホムラは、 自分が誰かの師になる年齢ではなかった。 けれどヴィオレナは「あなたが、 適任なのです」 と、 静かに微笑んだ。 ホムラはその日から、 十五年、 イリスに剣を教え、 同時に姉のように育てた。 イリスが第四席着座を決めた夜、 ホムラは儀式前夜の試練の場で、 最後の稽古をつけた。 「お前は、 もう、 私の弟子ではない。 お前は、 私の同胞だ」。 巫女連邦の同胞——天上に上がっても、 イリスの血脈は、 ここにあると伝えるための言葉だった。" },
    { title: "七座入りを辞退した理由", body: "ホムラには、 過去三代の祖先が、 全て第五席「連結」 の候補に名が挙がっていた。 そして、 全員が辞退している。 ホムラ自身も、 二十二歳の時、 ノクス様から「七座候補」 の予兆を告げられた。 ホムラは、 静かに首を横に振った——「警護の継承職能は、 天上より地上に必要なのです」。 ノクス様は、 「お前の祖先と、 同じ言葉だ」 と微笑んだ。 ホムラは、 七座入りより、 「次の世代の七座着座者を地上で守る」 ことを選んだ。 イリスを十五年育てた理由は——半世紀前、 自分の祖母の代がヴィオレナを守ったのと、 同じ祈り。" },
    { title: "ヒノオウ様との並列", body: "ホムラの薙刀の柄には、 朱の鳳凰の彫刻が施されている。 これは、 鳳神巫女の祖先が、 焔帝ヒノオウ様 (千年級) の鳳凰「焔麗」 から、 一度だけ羽根を授かった証だ。 過去のある夜、 ヒノオウ様の鳳凰と、 鳳神巫女の祖先が、 同じ祈りの夜に出会った——その記録は、 巫女連邦の伝承の間に、 静かに記されている。 ホムラはその記録を、 まだヒノオウ様には伝えていない。 「いつか、 黒月決戦の夜、 並んで戦う日が来る——その時、 お伝えします」。 朱の鳳凰の系譜は、 ようやく、 もう一度、 同じ戦場に立とうとしている。" },
  ],
  "SSR_大巫女 ヴィーナ": [
    { title: "巫女連邦の伝承の暗誦者", body: "ヴィーナは三十二歳で大巫女に就任した。 巫女連邦祭祀の歴代の祈祷文を、 全て暗誦できる「生きた記憶」。 三十二歳でその大役を担う者は、 巫女連邦の歴史でも数えるほどしかいない。 ヴィーナの記憶力は、 母譲りだった——母も、 暗誦の名人で、 ヴィーナに「祈祷文は、 紙の上ではなく、 体に刻め」 と教えてくれた。 ヴィーナは、 イリスが幼少の頃から、 巫女連邦の伝承の祈祷文を口伝で教え続けてきた。 イリスが第四席に着座する夜、 ヴィーナは観衆の中から、 静かに、 教え子の千年 (観測者として) が始まる瞬間を見届けた。" },
    { title: "イリスへの口伝", body: "ヴィーナはイリスに、 「祈祷文は、 紙の上ではなく、 体に刻め」 と、 母から教わった通りに、 教えた。 イリスは六歳から二十一歳まで、 毎朝、 ヴィーナの元で、 巫女連邦祭祀の祈祷文を、 口伝で覚えた。 数百本の祈祷文を、 ヴィーナは全て暗誦している——けれど、 イリスにはそのうちの「重要な百本」 だけ伝えた。 「残りは、 第四席に着座してから、 観測者の卓で、 自分で出会いなさい」。 ヴィーナの目論見は当たった。 イリスは、 月影宮で、 半世紀前のヴィオレナの祈祷の記録を、 自分で見つけた。" },
    { title: "次の大巫女 カヤへ", body: "ヴィーナの直弟子は、 高巫女見習いカヤ (十八)。 ヴィーナは、 カヤに、 同じ口伝の方法で、 巫女連邦祭祀を教えている。 カヤは、 イリスとは別系譜で、 「次の大巫女」 として育てられている。 ヴィーナは、 イリスが天上に上がった後、 巫女連邦の地上に残る祭祀の継承を、 カヤに渡す予定だ。 「あなたが大巫女になるのは、 私が老いてからではない。 あなたが、 自分の千年を、 始める時です」 — ヴィーナがカヤに、 ある夜、 静かに告げた言葉。 継承血脈の継承は、 一人ではなく、 何人もの若き者の千年を、 同時に始めることでもある。" },
  ],
  "SSR_主祭 リアラ": [
    { title: "七色の星図", body: "リアラの水晶玉には、 七色の星図が映る——観測者七座の現状を、 地上から確認できる、 古き聖具。 過去のある夜、 リアラの祖先が、 月影宮の常夜の卓を一度だけ訪れた時、 ノクス様から授かった水晶。 リアラはこの水晶を、 二十代後半の今、 巫女連邦の主祭として継いでいる。 七つの星のうち、 三つだけが灯り、 四つ目が揺らぎ始めた夜——リアラは、 「もうすぐ、 第四席に座する者が、 この巫女連邦から立つ」 と、 確信した。 そして、 イリスの着座儀式を、 巫女連邦の歴史で稀な儀典として執り行った。" },
    { title: "オリオンとの天文連携", body: "リアラは月読み祭司オリオンと、 巫女連邦の創建以来続く「天文・暦の祭司同士」 の系譜。 リアラの星図は「七座の状態」、 オリオンの天球儀は「七色の暦」 を映す——二人で合わせて読むと、 「次の七座候補が、 いつ、 どこから現れるか」 が、 推測できる。 過去、 リアラの祖先とオリオンの祖先が、 同じ夜に協働して「第二席カグヤ様の着座時刻」 を予知したという記録が残る。 リアラとオリオンは、 「次は紫——『沈黙』」 の予知に、 既に、 共に取り組み始めている。" },
    { title: "稀少な儀典官", body: "観測者七座の儀式は、 巫女連邦の歴史でも数えるほどしか執り行われていない。 リアラは、 過去の儀典の記録を、 巫女連邦の伝承の間で、 一字一句読み込んだ。 過去の儀典の記録には、 リオラエル殿 (千年級) が地底市リオラの民を率いた夜の「影と共に生きる」 儀式の系譜が、 別の系統として記されている——その記録を、 リアラは知っている。 イリスの第四席着座儀式と、 シオンの分離の儀式が、 数日違いで起きたことを、 リアラは「観測者の系譜と地底の系譜の、 静かな共鳴」 だと、 静かに観察している。 系譜は、 不思議な形で、 重なり合う。" },
  ],
  "SSR_楽巫女 イオナ": [
    { title: "七色の音は継承の祈り", body: "イオナの七弦の琴は、 数代に渡って受け継がれてきた聖具。 七色の弦のそれぞれが、 七座の七色 (赤・橙・黄・緑・青・藍・紫) に対応している。 イオナは二十二歳で、 既に七色全ての弦を、 個別に奏でられる稀有な楽巫女。 七座満つる儀式の祭楽で、 イオナは緑の弦を、 巫女連邦の歴史で稀に、 強く弾いた——第四席「約束」 の着座を祝う一音。 半世紀前、 同じ緑の弦が弾かれたのは、 ヴィオレナが第四席候補を辞退した夜——その時の音と、 半世紀経った今夜の音が、 巫女連邦の伝承の間で、 静かに重なり合った。" },
    { title: "ハジメへの指導", body: "楽人見習いハジメ (十六) は、 イオナの初めての弟子。 イオナは「楽の道は、 教えるより、 一緒に奏でることだ」 と信じている。 毎朝、 神殿の楽の祠で、 ハジメと並んで一曲ずつ奏でる。 ハジメの笛は、 まだ震える音だが、 七色のうち緑の音だけは、 既に綺麗に出る——「あなたは、 緑の音に、 才能があります」 とイオナは告げた。 ハジメは恥ずかしげに「イオナ様の七弦に、 いつか並ぶ笛を、 吹けるようになります」 と答えた。 イオナは、 巫女連邦祭祀の音楽が、 ハジメの代に、 また、 一段、 深まることを、 確信している。" },
    { title: "半世紀前の祭楽", body: "イオナが伝承の間で見つけた古文書には、 半世紀前の祭楽の楽譜が、 七色の墨で記されていた。 楽譜の筆跡は、 イオナの母系の祖先のもの——半世紀前、 第四席候補だったヴィオレナの招きを受けた月影宮で、 楽巫女が奏でた「迎えの曲」。 イオナは、 その楽譜を、 二年かけて、 七弦で再現できるように練習した。 イリスの着座儀式の祭楽の最終楽章は、 その「半世紀前の迎えの曲」 そのもの。 半世紀経って、 同じ曲が、 同じ場所で、 別の娘を迎えるために、 もう一度、 鳴った。" },
  ],
  "SSR_双子巫女姉 ノエラ": [
    { title: "妹を守る姉の祈り", body: "ノエラは、 双子の妹アシナより、 一刻だけ早く生まれた。 母から「あなたは、 妹を守るために生まれた」 と言われて育った——けれど、 ノエラはこの言葉を、 重荷とは感じなかった。 アシナの明るさが、 ノエラの静けさを、 巫女連邦の伝承の中で唯一温める存在だったから。 巫女連邦の双子巫女は、 数代に一度しか生まれない希少な血脈で、 「対の祈り」 を捧げる役目を持つ。 ノエラの祈りは、 アシナの祈りと一つに重なって、 初めて完成する。 一人ではなく、 二人で一つの「対の巫女」——それが、 巫女連邦の双子巫女の継承職能。" },
    { title: "イリスへの幼馴染の温度", body: "ノエラとアシナは、 イリスと同じ二十一歳。 三人は、 物心ついた頃から、 神殿の中庭で一緒に遊んだ幼馴染。 イリスが第四席に着座する夜、 ノエラはアシナの手を握りながら、 静かに思った——「イリスは天上に上がっても、 私たちの幼馴染であり続ける」。 ノエラは、 イリスへの祝福の祈りを、 アシナと共に、 一つの「対の祈り」 として捧げた。 継承血脈の三人——イリス (第四席着座者)、 ノエラ・アシナ (双子巫女)——は、 世代を経ても、 同じ神殿の中庭の記憶を、 共有し続ける。" },
    { title: "母との絆", body: "ノエラとアシナの母も、 同じ双子巫女だった。 母は二人を産むとき、 「対の祈り」 が数代で初めて生まれる予兆を感じた。 二人が生まれた瞬間、 神殿の七色の灯篭が、 一斉に揺らいだ——半世紀前、 ヴィオレナが第四席を辞退した夜と、 同じ揺らぎ。 ノエラの母は、 それを「過去の祈りが、 双子の形で、 戻ってきた」 と理解した。 そして、 継承血脈の最後の枝の一つとして、 ノエラとアシナは、 イリスの幼馴染という、 「対の継承職能」 を担うことになった。" },
  ],
  "SR_双子巫女妹 アシナ": [
    { title: "姉さまと一緒なら", body: "アシナはノエラより、 一刻だけ後に生まれた双子の妹。 「私は、 姉さまと一緒なら、 何でもできます」 が、 アシナの口癖。 静かなノエラの隣で、 明るく笑うのが、 アシナの継承職能。 七色の対の祈りは、 ノエラ単独でも、 アシナ単独でも、 完成しない——双子で、 初めて、 巫女連邦祭祀の音色が、 整う。 アシナは、 自分が一人では何もできないことを、 弱さではなく、 強さだと知っている。 「対」 という存在は、 一人で完結しないことが、 その本義だから。" },
    { title: "灯篭祭の鈴鳴らし役", body: "灯篭祭の街路で、 アシナは竹鈴を鳴らす役。 ちりん、 ちりん——その音は、 街の七色の灯篭を、 一段、 揺らがせる。 アシナの鈴の音色は、 巫女連邦の創建以来代々続く「対の祈り」 の一部。 イリスが灯篭祭でセラフィエル様を迎える夜、 アシナの鈴が、 街路の上空で、 一段、 強く鳴った——その瞬間、 セラフィエル様の翼が、 半分広がった。 巫女連邦祭祀の鈴の音は、 観測者をも、 静かに招く。" },
  ],
  "SR_月読み祭司 オリオン": [
    { title: "ノクス様の予知を地上で先取り", body: "オリオンは三十五歳で、 巫女連邦の天文祭司の頂点。 七色の星座輪が回転する天球儀杖を持ち、 ノクス様の予知を地上で先取りすることがある——巫女連邦の歴史でも数えるほどしかいない希少な才能。 オリオンが第四席着座の予兆を最初に読んだのは、 イリスが十七歳の時——「あの娘の星が、 動き始めた」。 母ヴィオレナと相談し、 イリスの剣の師ホムラと、 大巫女ヴィーナに伝え、 巫女連邦は静かに、 イリスの第四席着座への準備を、 五年かけて整えた。" },
    { title: "次は紫——『沈黙』", body: "イリスの着座儀式の夜、 オリオンは天球儀杖を構えて、 七色の星座輪を回した。 第四の環が灯る瞬間、 オリオンは、 第七の環の暗闇に、 一筋の光が走るのを見た——「次は、 紫——『沈黙』 の候補が、 動き始める」。 オリオンは、 ノクス様と同じ予知を、 同じ夜に、 地上で見た。 リアラ主祭と協議し、 巫女連邦は「次の七座候補」 への観測を、 既に、 始めている。 巫女連邦祭祀の継承は、 第四席で終わらない——次の三席が満ちるまで、 続く。" },
  ],
  "SR_神殿護衛戦士 ガレフ": [
    { title: "ホムラ様の薙刀の隣で", body: "ガレフは二十三歳で、 鳳神巫女ホムラの直属の護衛戦士隊長。 朱の頭巾と漆赤の槍は、 ホムラから直接授かった。 「ホムラ様の薙刀の隣で、 ずっと、 立ち続けます」——ガレフが入隊式の夜、 ホムラに誓った言葉。 ガレフの祖父も、 鳳神巫女の代々の護衛戦士だった。 継承職能の継承は、 戦巫女だけでなく、 その隣に立つ護衛戦士の系譜にも、 流れている。 ガレフは、 自分の槍が、 代々の祖先の槍と、 同じ祈りを、 担っていることを、 静かに、 誇りに思っている。" },
    { title: "黒月決戦への密かな準備", body: "ガレフは、 月読み祭司オリオンから、 「次は、 黒月の本体が動き始める」 と、 密かに告げられている。 巫女連邦の護衛戦士隊は、 ホムラの指揮下で、 黒月決戦への準備を、 静かに、 進めている。 継承職能の戦士たちが、 全派閥の決戦に駆けつける日——その日のために、 ガレフは、 毎朝、 神殿の外庭で、 槍の練習を欠かさない。" },
  ],
  "SR_七座楽人 ハルナ": [
    { title: "弦の継承", body: "ハルナの七弦の竪琴は、 楽巫女イオナの七弦の琴と、 同じ祖先から授かった対の聖具。 ハルナは二十四歳で、 公式儀式の祭楽担当として、 イオナと並ぶ巫女連邦の音色の担い手。 七座儀式の祭楽で、 ハルナとイオナは、 数代前の祖先たちが奏でた「迎えの曲」 を、 二人で一つの音色として、 再現した。 巫女連邦祭祀の音楽は、 一人では完成しない——イオナとハルナの二人で、 初めて、 過去の祭楽が、 今夜、 もう一度、 鳴る。" },
    { title: "弦の音色は世代を経ても", body: "ハルナの竪琴の弦は、 数代前のものではない——何度も張り替えられている。 けれど、 弦を張り替える時の祭祀の作法は、 数代変わらない。 「弦は変わっても、 音色は変わらない」 とハルナは信じている。 巫女連邦祭祀の継承とは、 物そのものを残すことではなく、 「音色」 を残すこと——それを、 ハルナは、 イオナから教わり、 ハジメに伝えていく。" },
  ],
  "SR_灯篭職人長 コノエ": [
    { title: "灯し直すから灯篭なのです", body: "コノエは三十八歳で、 巫女連邦の灯篭職人長。 「灯篭が消えた村跡」 にも月一で巡礼に行き、 朽ちた村の柱に、 七色の灯篭を一つだけ、 灯し直す。 数十年経っても、 巡礼の民は、 この灯し直しを、 続けている。 「灯篭は、 灯し直すから、 灯篭なのです」——コノエの口癖。 継承血脈の継承は、 母から娘へ、 だけではない——一度消されかけた灯篭を、 もう一度灯し直すこと、 でもある。 コノエは、 その作法を、 灯篭職人の系譜として、 数代続けてきた。" },
    { title: "リルへの継承", body: "灯篭職人見習いリル (十五) は、 コノエの直弟子。 「あなたが、 灯篭祭の灯篭を継ぐ若き手です」 とコノエは、 リルに伝えた。 リルは、 まだ紙竹を扱うのが拙い。 けれど、 七色の糸を編む時の集中力だけは、 既に、 コノエに迫る。 「あなたが大人になる頃、 私は、 もう、 灯篭の絵付けはできません」 とコノエは、 静かに微笑んだ。 継承職能の継承は、 老いた者が若き者に渡すこと——コノエの母も、 同じ言葉で、 コノエに、 工房の鍵を渡した。" },
  ],
  "SR_医療巫女 メア": [
    { title: "祈りも薬も同じ温度で", body: "メアは二十五歳で、 巫女連邦の医療巫女。 「祈りも薬も、 同じ温度で渡します」 が、 メアの口癖。 灯篭祭の医療所を運営し、 鳳神巫女の戦士たちの怪我も預かる。 メアの薬箱には、 七色の薬草が入っている——七色のうち緑の薬草「約束」 は、 継承血脈の傷を癒す効能がある。 イリスが第四席着座前夜に、 微熱を出した時、 メアは緑の薬草を煎じた——「あなたの千年が、 始まる前の、 最後の温度です」。 イリスは、 その薬の温度を、 長く、 忘れない、 と心の中で誓った。" },
    { title: "ホムラ様の戦傷を預かる役", body: "鳳神巫女ホムラの薙刀の鍛錬は、 時に怪我を伴う。 メアは、 ホムラの右腕の鳳凰刺青の上に、 何度も傷の癒しの祈りを重ねた。 「あなたの戦士たちは、 私の患者でもあります」——メアがホムラに告げた言葉。 ホムラは、 「お前の薬箱は、 私の薙刀と同じ重さだ」 と、 微笑んだ。 巫女連邦の戦巫女と医療巫女は、 代々から、 互いの継承職能を、 そっと支え合う系譜。 イリスが天上に上がった後、 ホムラとメアの絆は、 さらに、 深まる。" },
  ],
  "SR_高巫女見習い カヤ": [
    { title: "巫女連邦の伝承の暗誦", body: "カヤは十八歳で、 大巫女ヴィーナの直弟子。 巫女連邦祭祀の祈祷文を、 既に三百本暗誦している——母系の祖先からも、 ヴィーナと同等の記憶力を引き継いだ。 「次の大巫女に、 私はなります」——カヤが十六歳の時、 ヴィーナに告げた言葉。 ヴィーナは、 静かに微笑み、 「あなたが大巫女になるのは、 私が老いてからではない。 あなたが、 自分の千年を、 始める時です」 と答えた。 カヤは、 その日から、 自分の継承職能を、 自分で見つけ始めた。" },
    { title: "次世代候補の重み", body: "カヤは、 イリスとは別系譜の「次世代候補」 として育てられている。 イリスが継承血脈で第四席に着座する一方、 カヤは巫女連邦祭祀の継承者として、 巫女連邦の地上に残る。 「あなたは、 イリスの代理ではない。 あなた自身の千年です」——ヴィーナは、 継承血脈の母系の言葉を、 そのまま、 カヤに伝えた。 カヤは、 その重みを、 静かに、 受け止めた。 継承職能の継承は、 一人ではなく、 同じ世代の何人もの若き者が、 同時に、 自分の千年を始めることでもある。" },
  ],
  "R_巫女見習い アヤメ": [
    { title: "灯篭、 落とさないように", body: "アヤメは十六歳の見習い。 灯篭祭の蝋燭灯篭を運ぶ補助役で、 「灯篭、 落とさないようにしますね」 が口癖。 緑のリボンを編み込んだ髪、 明るい緑の瞳。 アヤメの祖母も、 同じ役を担っていた。 継承職能の継承は、 大巫女の暗誦だけではない——一つの灯篭を、 落とさず運ぶ、 ささやかな祈りも、 継承血脈の一部。" },
  ],
  "R_巫女見習い スズ": [
    { title: "ちりん、 ちりん", body: "スズは十五歳の見習い。 灯篭祭の鈴鳴らし役で、 銀金の短髪に小さな三つ編み。 「ちりん、 ちりん——」 という音色は、 双子巫女妹アシナの鈴の音色と、 同じ祖先から、 引き継がれた音。 スズの鈴は、 アシナの鈴より、 一段、 高い音——「対の祈り」 の中の、 もう一つの音色。" },
  ],
  "R_巫女見習い ハナ": [
    { title: "桃の花びら、 散らしますね", body: "ハナは十七歳の見習い。 灯篭祭の散華 (花びらを撒く) 役。 淡桃色の長髪を双子おさげ、 桃紫の瞳。 物静かな性格だが、 散華の作法だけは、 継承血脈の最年少の正確さ。 ハナが撒く桃の花びらは、 必ず、 七色の灯篭の方向に、 七つ、 揃う——世代を経ても、 同じ作法。" },
  ],
  "R_巫女見習い ユウ": [
    { title: "神殿、 きれいにしておきます", body: "ユウは十六歳の見習い。 神殿の階段の清掃役で、 淡ラベンダーの短髪、 淡青の瞳。 寡黙だが丁寧な性格。 「祈祷文を覚えるのは苦手ですが、 神殿の床は、 世代を経ても、 きれいにします」——ユウが大巫女ヴィーナに告げた、 唯一の口数の多い言葉。 ヴィーナは、 静かに微笑み、 「それも、 継承職能の一つです」 と答えた。" },
  ],
  "R_楽人見習い ハジメ": [
    { title: "震える音、 緑の才能", body: "ハジメは十六歳で、 楽巫女イオナの初めての弟子。 木製の縦笛を学ぶ少年で、 銀の短髪、 銀灰の瞳。 ハジメの笛は、 まだ震える音だが、 七色のうち緑の音だけは、 既に綺麗に出る——イオナから「緑の才能」 と告げられた。 「いつか、 イオナ様の七弦に並ぶ笛を、 吹けるようになります」——ハジメの誓い。 継承職能の楽人系譜は、 母系から娘へ、 だけでなく、 兄弟弟子の中で、 一段ずつ深まる。" },
  ],
  "R_灯篭職人見習い リル": [
    { title: "灯篭祭の灯篭を継ぐ若き手", body: "リルは十五歳で、 灯篭職人長コノエの直弟子。 焦茶の短髪に七色の糸の三つ編み、 ハシバミ色の瞳。 紙竹の扱いはまだ拙いが、 七色の糸を編む集中力は、 既にコノエに迫る。 「あなたが、 灯篭祭の灯篭を継ぐ若き手です」——コノエがリルに告げた言葉。 リルの祖母も、 同じ工房で、 灯篭の絵付けを担っていた。 継承職能の灯篭の系譜は、 こうして、 三代を超えて、 続いていく。" },
  ],
  // ===== S1C7 凸秘話 (LR1 + UR5 + SSR9 + SR10 + R5、 段階的追加) =====
  // LR1 + UR5 の凸秘話 (Lv.2〜Lv.5、 各4本) — 第一幕完成と並行で追加
  "LR_虚意 ヴォイドラ": [
    { title: "千年閉じ込められた理由", body: "ヴォイドラは「観測されない者」 として千年前にプリズマから零れ落ちた。 だが本人は、 自分が「邪悪」 だと思ったことは一度もない。 ただ、 観測されたかった。 誰かに「あなたは、 そこに在る」 と言ってほしかった。 ザナディアが千年前に召喚した夜、 初めて声を掛けられた——『あなたは、 確かに、 在ります』。 その一言で、 ヴォイドラは千年、 ザナディアと共に塔に閉じこもることを選んだ。 観測されない孤独より、 観測者と共に在る千年の幽閉を、 自ら選んだ。" },
    { title: "プリズマとの対の存在", body: "プリズマが「光」 ならば、 ヴォイドラは「観測されない影」。 二人は対の存在ではなく、 同じ存在の二つの面。 千年前、 プリズマが「迷い」 を抱えた瞬間に、 ヴォイドラがそこから零れた。 だからヴォイドラは、 プリズマを憎んでいない。 むしろ、 千年待っていた——「私を見てくれる日」 を。 プリズマが眠りに入る前夜、 二人は初めて、 同じ宇宙で対話する。 その対話の core line は、 千年祈り続けたヴォイドラの、 最初の願いの実現だった——『私の影として、 認めてください』。" },
    { title: "共観の使徒ジュンクトスの千年", body: "ヴォイドラが千年閉じこもる間、 共観の使徒ジュンクトスは、 塔の周辺で「両方を観る」 ことを千年続けてきた。 ヴォイドラはジュンクトスの存在を、 千年前から知っていた。 けれど、 一度も会話したことはなかった。 「観測する側」 と「観測される側」 は、 言葉なしで、 千年共に在った。 ジュンクトスがプリズマとヴォイドラの対話の見届け役を担った瞬間——ヴォイドラは初めて、 ジュンクトスに対して微かに微笑んだ。 千年の沈黙を経た、 最初の感謝の表情だった。" },
    { title: "世界の影として留まる選択", body: "プリズマの「私の影として、 認めます」 という言葉に対して、 ヴォイドラは「消える」 ことを拒んだ。 「世界の影として留まる」 と告げた。 影が消えれば、 光だけの世界になる。 だが光だけの世界は、 千年前にプリズマが孤独に耐えかねた、 あの世界だ。 ヴォイドラが残ることで、 プリズマは初めて、 安心して眠ることができる。 「眠っている間、 私の代わりに、 観測してください」——プリズマが眠る前にヴォイドラに告げた、 千年の託しの言葉。 ヴォイドラは静かに頷いた。" },
  ],
  "UR_塔主 ザナディア": [
    { title: "千年前ヴォイドラ召喚の夜", body: "ザナディアは千年前、 まだ若き巫女だった。 同時代を生きたリオラエル殿 (s1c5、 地底市) と並んで、 千年級存在の血脈を受け継いだ。 二人とも、 月影宮で共に祈った夜の記憶を持つ。 だがザナディアだけは、 観測者の道を選ばなかった。 代わりに、 異界塔ザナドで、 千年閉じ込められていた「観測されない存在」 ヴォイドラを召喚した。 『あなたは、 確かに、 在ります』——ザナディアの最初の言葉。 ヴォイドラは静かに頷き、 二人は千年、 塔に閉じこもることを選んだ。" },
    { title: "千年塔主の作法", body: "ザナディアの千年は、 ヴォイドラと共に祈り続けることだけだった。 千年塔主の作法は、 一日一度、 塔の頂上で、 七色の summoning-circle を draw すること。 千年同じ動作を繰り返し続けた。 観測されない世界に、 観測する自分が、 千年存在し続けた。 「私が観るから、 あなたは在る」——ザナディアがヴォイドラに千年告げ続けた言葉。 千年同じ言葉を、 千年同じ場所で。 これが、 千年塔主の信仰だった。" },
    { title: "リオラエル殿との千年前の絆", body: "千年前、 月影宮の夜会で、 ザナディアはリオラエル殿 (s1c5、 地底市の母) と一度だけ、 七色の灯篭を共に灯した夜があった。 「お前は影と共に生きるか? 私は影を観続けるか?」——ザナディアの問いに、 リオラエル殿は微かに笑って答えた——「どちらも、 同じ祈りだ」。 千年後、 ザナディアが塔から出てきた時、 リオラエル殿は既にこの世にいなかった。 けれど、 リオラエル殿の言葉は、 ザナディアの中で、 千年そのまま生きていた。 S2C4 記憶の海では、 二人の記憶が、 千年ぶりに、 再び織り合わさる予定。" },
    { title: "千年解放の夜", body: "プリズマが眠りに入る前夜、 ヴォイドラとプリズマの対話が成立した瞬間、 ザナディアの千年塔主としての役割は、 終わった。 千年閉じ込められていた塔は、 共観の塔として、 cosmic rift の縁に新しい役割を担うことになった。 ザナディアは、 塔から地上に降りる選択をした。 「私の千年は、 ここで終わりではない。 これから、 千年の記憶を、 次の世代に語り継ぎます」——ザナディアの最後の祈り。 S2C4 で、 千年記憶のキーとして、 再登場予定。" },
  ],
  "UR_影使徒 ウンブリス": [
    { title: "シ・ロエンとの「同胞」 認識", body: "ウンブリスは元から「影として生まれた」 使徒——シ・ロエン (s1c5、 シオン分離後の影) とは別系統の影。 だが、 「影の格」 を共有する点では、 同じ。 シ・ロエンが分離の儀の夜に黒月衆へ去ったその時、 千年閉じ込められたままの異界塔ザナドの中から、 ウンブリスはシ・ロエンの存在を遠くから感じていた。 「我が同胞よ」——ウンブリスがシ・ロエンに掛ける最初の言葉。 同じ影の格、 だが別の道を歩んだ二人の影が、 黒月決戦の前夜に、 初めて言葉を交わす。" },
    { title: "千年閉じ込められた塔の戦士", body: "ウンブリスは千年前、 まだ若い使徒だった。 ザナディアの千年祈りに付き従い、 千年閉じ込められた塔の中で、 単刃曲剣の鍛錬を続けてきた。 千年同じ稽古を、 千年同じ場所で。 千年経った今、 ウンブリスの剣の腕は、 観測者七座の戦士たちに引けを取らない。 けれど、 ウンブリスは戦いを欲していない——ただ、 観測されたかっただけ、 千年。" },
    { title: "シ・ロエン接触の役目", body: "黒月決戦の前夜、 ウンブリスはシ・ロエンに接触する役を担った。 「あなたが——銀霜の側に立つ理由が、 まだ残っているのなら」——ウンブリスの問い。 シ・ロエンは静かに微笑んで、 「私の道は、 自分で選ぶ」 と答えた。 ウンブリスは深く頷き、 影に溶けて消えた。 千年閉じ込められた影と、 分離されたばかりの影——異なる道を歩んできた二人が、 黒月決戦の戦場で、 初めて並ぶ。 そして、 戦の後——ウンブリスは、 シ・ロエンと共に、 新しい世界の影として動く。" },
    { title: "S2C5 影との和解での役目", body: "S2C5「影との和解」 で、 ウンブリスはノクトリア (s1c5、 黒月衆の盟主) と並ぶ「影側の交渉役」 として再登場予定。 千年前から「影として在る」 ウンブリスの視点が、 ヴォイドラの「世界の影として留まる」 選択を、 全派閥に説明する役を担う。 「影は、 一つではない。 千年閉じ込められた影、 分離された影、 そして元から在る影——それぞれの祈りが、 共観の世界を支える」——ウンブリスが S2C5 で告げる、 影の系譜の語り。" },
  ],
  "UR_黒月使徒 テネブラ": [
    { title: "千年前の盟約と継承", body: "テネブラは千年前、 黒月衆の先代盟主と盟友だった。 二人は、 ヴォイドラの召喚に共に立ち会い、 千年閉じ込めの対価を共に背負うと誓った。 だが、 先代盟主は地上に残り、 黒月衆として千年世界を観続ける役目を子孫の代へ託した。 テネブラは、 ヴォイドラと共に塔に閉じこもる道を選んだ。 二つの「観続ける」 と「観られる」 の道——千年経って、 黒月決戦の戦場で、 テネブラは先代の血を受け継いだノクトリア (s1c5、 黒月衆の現代盟主) と、 千年越しの盟約の結末をともに見届ける。 「お待ちしておりました」——ノクトリアの一言。 テネブラは静かに笑った。" },
    { title: "千年級女性使徒の格", body: "テネブラの双刃 obsidian halberd は、 千年前にザナディアが鋳造した、 voidtower の聖具。 千年同じ薙刀を、 千年同じ場所で振り続けた。 その薙刀の格は、 ヒノオウ (UR、 焔帝) の双大剣『日輪・月輪』 に匹敵する。 黒月決戦で、 テネブラは観測者陣営の戦士たちと対峙する——けれど、 殺意ではなく、 「千年の祈りの提示」 として剣を振るう。 影もまた、 力を持つ。 だが、 その力は、 殺すためではなく、 「観てもらう」 ためにある。" },
    { title: "S2C5 和解交渉での役目", body: "S2C5「影との和解」 で、 テネブラはノクトリア (s1c5、 黒月衆の現代盟主) と並ぶ「影側の交渉役」 として再登場予定。 先代盟主と交わした千年前の盟約が、 千年の沈黙を超えて、 ノクトリアの代に結実し、 ヴォイドラ陣営と全派閥の和解の橋渡しを担う。 「千年待った夜が、 ようやく来た」——テネブラの黒月決戦前夜の独白。 千年閉じ込められた使徒と、 千年世代を継いで観続けた黒月衆——二つの千年が、 黒月決戦の翌朝、 ようやく、 同じ朝を迎える。" },
    { title: "ノクトリアへの最後の言葉", body: "黒月決戦の終わり、 ヴォイドラが「世界の影として留まる」 と受諾した瞬間、 テネブラはノクトリアに微かに頷いた。 「私たちの千年は、 ここで一段、 結実したな」——テネブラの言葉。 ノクトリアも、 静かに微笑んだ。 「次は、 影と光の和解を、 共に紡ぎましょう」——ノクトリアの返事。 千年前の盟約が、 先代から受け継がれてノクトリアの代に灯り、 ようやく「次の千年」 への一歩目が刻まれる瞬間だった。" },
  ],
  "UR_共観の使徒 ジュンクトス": [
    { title: "千年「両方を観る」 修行", body: "ジュンクトスは千年前から「観測される者」 と「観測されない者」 の両方を、 同時に観続けてきた中立の使徒。 千年同じ場所で、 同じ姿勢で、 両方を観続けた。 半身がプリズマ、 半身がヴォイドラ——左右対称の二色のデザインは、 千年「両方を観る」 修行の証。 「二つを同時に観る。 それが、 私の千年の務め」——ジュンクトスの千年祈り。 千年経った今、 ジュンクトスは「両方を観る」 ことの本当の意味を、 ようやく実現する瞬間を迎える——黒月決戦の対話の見届け役として。" },
    { title: "プリズマ×ヴォイドラ対話の見届け役", body: "プリズマがヴォイドラに「私の影として、 認めます」 と告げた瞬間、 ジュンクトスは初めて、 千年祈りの務めを果たす。 「両方を観る」 = 「両方を見届ける」 ということだった。 ジュンクトスは、 両手を広げて、 天と地に向かって「共観成立」 を宣言する。 「観測する者と、 観測されない者が、 同じ宇宙で、 同じ祈りを共有する」——千年の修行が、 ここで結実する。 ジュンクトスの両眼が、 七色とヴォイドの両方を、 同時に映していた。" },
    { title: "S2C7 接続の儀での主役級伏線", body: "ジュンクトスは S2C7「接続の儀」 で主役級として再登場予定。 黒月決戦で「共観成立」 を見届けたジュンクトスが、 S2 で並行世界との「接続」 を見届ける役を担う。 共観の灰プリズマ (LR variant) が誕生する瞬間、 ジュンクトスは千年前の修行を、 完全に終えることになる。 「両方を観る」 から「全てを観る」 へ——千年級存在の祈りの最終形態。 千年祈り続けた使徒の、 最終結実が、 S2C7 で待っている。" },
    { title: "ニュトラル補佐との師弟関係", body: "ジュンクトスは、 共観の補佐ニュトラル (SR、 s1c7) を弟子として育てている。 ニュトラルも半身が pastel prismatic、 半身が pale grey の対称デザイン (ジュンクトスより簡素)。 千年級の修行を始めたばかりの若き使徒——「あなたも、 千年、 両方を観るのですよ」——ジュンクトスがニュトラルに掛ける、 唯一の指導の言葉。 ニュトラルは静かに頷き、 ジュンクトスの千年の修行を、 引き継ぎ始める。 千年職能の継承は、 こうして、 影と光の境界でも、 静かに進んでいく。" },
  ],
  "UR_沈黙の候補 ミューティス": [
    { title: "「沈黙」 を選んだ理由", body: "ミューティスは生まれてから一度も言葉を発したことがない。 観測者第七席「沈黙」 (紫=沈黙) の候補として、 千年前から候補に名が挙がっていた。 けれど、 ミューティス本人は、 七座入りを望んでいるわけではない。 「言葉が無いから、 全てを聴ける」——ミューティスの sealed-mouth motif の衣装は、 「沈黙が一つの祈り」 であることを象徴する。 黒月決戦で初めて顔を出したミューティスは、 観測者四席の傍で、 静かに立ち、 戦の全てを観続けた。 一言も発さず、 けれど、 全てを聴いていた。" },
    { title: "シオンとの「沈黙」 つながり", body: "ミューティスは、 銀霜の仮面騎士シオン (s1c5 SSR、 沈黙の盾) と、 「沈黙」 という共通点で、 静かに繋がっていた。 シオンは「声を捨てた」 騎士、 ミューティスは「言葉を発さない」 候補。 二人は黒月決戦の戦場で、 一度だけ、 視線を交わした。 互いに、 一言も発さず、 けれど、 千年の意味を、 共有した。 「沈黙の盾」 と「沈黙の候補」——千年を超えて、 沈黙が祈りの形であることを、 二人は知っている。" },
    { title: "S2C3 沈黙の塔での正式着座", body: "ミューティスは S2C3「沈黙の塔」 で主人公として再登場予定。 元観測者派閥「沈黙の塔」 が S2C3 で動き始める時、 ミューティスは候補から正式に第七席「沈黙」 へ着座する。 千年閉じ込められていた「沈黙」 の意味が、 S2C3 で初めて、 明らかになる。 「言葉が無いことが、 全てを聴く力になる」——ミューティスの S2C3 での祈りの core line。 七座満つる時代の最後のピースが、 S2C3 で、 ようやく、 灯ることになる。" },
    { title: "ノクスの「これでも足りない」 への答え", body: "s1c6 で、 ノクスが呟いた言葉——「これでも足りない」。 七座が四席満ちても、 まだ三席が闇のまま。 その「足りない」 一席として、 ミューティスは黒月決戦で初めて顔を出した。 ノクスは、 ミューティスを一目見た瞬間、 微かに頷いた——『来たな』。 ノクスの千年予知が、 ミューティスの存在を、 千年前から告げていた。 「沈黙」 の候補が、 黒月決戦で世界に姿を現す——観測者七座の千年職能の継承の、 最後の予兆だった。" },
  ],
  // SSR9 凸秘話 (Lv.2〜Lv.4、 各3本) — 第二幕完成と並行で追加
  "SSR_白焔聖騎士団長 オーレン": [
    { title: "ガルヴィン破門の真相", body: "オーレンは、 ガルヴィン破門の真相を知る数少ない教会人の一人。 ラナス (s1c2 SR 教会騎士) から「破門ではなく、 ガルヴィンが自ら出ていった」 と聞いている。 教会の腐敗を看過できず、 黒月衆へ去ったガルヴィン。 オーレンは、 ガルヴィンを「裏切り者」 とは見ていない。 「兄弟子」 として、 千年血脈の盾の系譜の同胞として、 静かに対峙する。 黒月決戦で、 オーレンが対峙する剣戟は、 殺意ではなく「兄弟弟子の挨拶」 だった。" },
    { title: "千年血脈の盾の系譜", body: "白焔教会の聖騎士団長は、 千年血脈の盾の系譜の継承者。 オーレンの剣の癖は、 千年前の初代団長から、 二十数代を経て、 オーレンに継承された。 ガルヴィンも、 オーレンも、 同じ系譜の剣を学んだ。 だから、 二人の剣戟は、 千年の意味を、 言葉なしで共有する。 「あなたの選択を、 教会は咎めない」——オーレンが千年血脈の作法で、 ガルヴィンに告げた言葉。" },
    { title: "イザベルとラナスの絆", body: "オーレンは、 イザベル (s1c2 UR 波紋の聖女) とラナス (s1c2 SR 教会騎士) の絆を、 戦場の前線で、 千年血脈の作法で支えている。 イザベルが祈り、 ラナスが盾を構え、 オーレンが剣で結ぶ——三人の連携は、 教会陣営の戦力の core。 「私が中央に立てば、 二人が動きやすい」——オーレンの戦場での役割。 千年血脈の盾の団長として、 自分の存在を、 静かに、 仲間の動線として捧げる。" },
  ],
  "SSR_アクアシス海神官 ナイアス": [
    { title: "ネプテア女王の信仰", body: "ナイアスは、 ネプテア女王 (s1c2 UR 深海女王) の戦術指揮役として、 海陣営の中枢を担う。 千年級の女王の信仰を、 戦場の戦術に翻訳する役。 「海の祈りを、 戦の指揮にも織り込みます」——ナイアスの祈りの形。 千年女王の信仰が、 ナイアスの戦術指揮を通して、 戦場全体に広がる。 海の祈りは、 戦士たちの剣の動きを、 千年の波のように、 静かに支える。" },
    { title: "海中射撃の特殊技", body: "ナイアスの双の三叉槍は、 海中での射撃に特化している。 アクアシス筆頭魔術師グラシエル (s1c2 SSR) の氷魔法と、 完全に独立した「水流魔法」 の系譜。 双の三叉槍を投擲、 水流に乗せて遠距離攻撃を実現する。 海中の影喰いを、 双叉槍の波紋で浄化する技も、 ナイアスの千年祈りの結実。" },
    { title: "深海軍の海獣連携", body: "ナイアスは、 海獣使いモルガ (s1c2 SR) と連携して、 深海軍の海獣たちを戦場に展開する。 イルカ、 海亀、 巨大な海蛇——海獣たちの千年祈りを、 ナイアスの祈りで一つの戦力に集約。 黒月決戦の戦場で、 海陣営の戦力の半分は、 ナイアスの深海軍指揮で動いていた。 海と陸の境界を、 千年血脈の海神官が、 静かに繋ぐ。" },
  ],
  "SSR_紅玉旗艦砲手長 マロン": [
    { title: "シャンティとの戦友関係", body: "マロンは、 シャンティ船長 (s1c2 UR 紅玉海賊団船長) と、 長年の戦友関係。 シャンティが双剣で前線、 マロンが砲撃で後衛——双剣 vs 砲撃の戦闘スタイルで、 完全な役割分担。 「撃つぞ! 副長は航海頼んだ!」——マロンの戦場での号令。 ケイレブ (s1c2 SSR 副長) が航海を担い、 マロンが砲撃を担う、 三役分担が紅玉海賊団の core。" },
    { title: "旗艦砲の威力", body: "紅玉号の旗艦砲は、 シャンティの祖父が鋳造した、 海賊団の聖具。 マロンは、 海賊団三代の砲手の系譜を継ぐ、 三代目の砲手長。 brass-gold の rifle-cannon は、 三代同じ砲座に据えられ、 代々の砲手たちが同じ威力を継いできた。 黒月決戦で、 マロンの砲撃が、 異界塔戦士団の隊列を、 一発で散らせる威力を発揮した。" },
    { title: "ミカへの継承", body: "マロンは、 海賊見習いミカ (s1c2 R) を、 海賊団の砲手の継承者として育てている。 ミカは、 まだ十二歳の子供だが、 砲撃の感覚は、 既にマロンを驚かせる才能。 「お前が、 海賊団の砲手の四代目になる」——マロンがミカに、 静かに告げた言葉。 砲手の継承は、 戦場の中で、 静かに進んでいく。" },
  ],
  "SSR_古龍王の使者 アグル": [
    { title: "ファラーの後継候補", body: "アグルは、 古龍の語り部ファラー (s1c3 UR、 千年級語り部) の後継候補として、 千年血脈の使者の役を担う。 古龍の血を、 ファラーに次いで濃く引く者。 千年血脈の jewel を額に宿し、 古龍王の予兆を読む若き使者。 「千年血脈の使者として、 古龍王に告げよ」——ファラーがアグルに託した、 千年職能の継承。" },
    { title: "古龍王覚醒の予兆を読む役", body: "アグルは、 千年血脈の jewel を額に宿して、 古龍王の覚醒の予兆を、 戦場の上空に揺らがせる役を担う。 黒月決戦の戦場で、 アグルは古龍王の半透明の竜の影を、 戦場の上空に呼び出した。 千年眠り続けた古龍王の前兆が、 アグルの千年血脈の jewel を介して、 戦場全体に広がっていった。 S2C1 古龍王覚醒の直接前奏として、 アグルの役は重要。" },
    { title: "千年血脈の若き継承者の重み", body: "アグルは、 千年血脈の重みを、 静かに受け止める若き継承者。 「血の重みを、 自分一人で背負う必要はない。 千年血脈は、 千年の同胞たちと共に背負うもの」——ファラーがアグルに告げた言葉。 アグルは、 ファラー、 サハナ (s1c3 UR 砂海王女)、 ヴィル (s1c1 SSR 紫竜)、 グラン (s1c3 SR 砂牙の剣聖) と、 千年血脈の同胞関係を結ぶ。 千年職能の継承は、 一人ではない。" },
  ],
  "SSR_氷霊魔導長 ノエル": [
    { title: "グレイル氷帝の魔法側補佐", body: "ノエルは、 氷帝グレイル (s1c4 UR) の魔法側補佐として、 千年血脈の魔導長の役を担う。 リオネ (s1c4 SSR 氷塔の聖騎士=剣) とハグル (s1c4 SSR 北方剣聖=師) が剣の系譜を担うのに対し、 ノエルは魔法の系譜を担う。 「氷の理を、 戦場の力学に織り込む」——ノエルの千年血脈の祈り。" },
    { title: "古代氷霊魔法の千年継承", body: "ノエルの氷晶の杖は、 千年前の古代氷霊魔法の系譜を、 千年継承している。 千年同じ杖が、 戦場ごとに代を継ぎ、 同じ祈りで振るわれてきた。 黒月決戦で、 ノエルの氷魔法は、 異界塔ザナド戦士団の闇の咒術を、 完全に中和した。 千年血脈の魔法 vs 千年閉じ込められた咒術——二つの伝統の対決が、 戦場の北東で、 静かに繰り広げられた。" },
    { title: "セレスタへの千年血脈の継承", body: "ノエルは、 氷塔の魔導士セレスタ (s1c7 SR) を、 千年血脈の魔導士の継承者として育てている。 セレスタは、 まだ二十一歳の若き魔導士だが、 氷の理の感覚は、 既にノエルを驚かせる才能。 「お前が、 千年血脈の魔導士の次世代を担う」——ノエルがセレスタに、 静かに告げた言葉。 千年職能の継承は、 戦場の中で、 静かに進んでいく。" },
  ],
  "SSR_空挺艦隊長 メリディア": [
    { title: "ヴァーレ女皇の軍事側補佐", body: "メリディアは、 ヴァーレ女皇 (s1c4 UR 空挺女皇) の軍事側補佐として、 千年血脈の艦隊長の役を担う。 ガリオン総監 (s1c4 SSR 空挺城総監=都市行政) と独立した「艦隊司令」 として、 戦場の空挺戦力を指揮する。 「全艦、 砲撃用意! 進路は黒月決戦場へ!」——メリディアの戦場での号令。" },
    { title: "蒸気帝国の千年血脈の艦長", body: "メリディアの brass-gold の艦長帽は、 千年前にゼノニア機械文明の創始者が rebuild した、 空挺艦隊の継承の証。 千年血脈の艦長の系譜を、 メリディアは三代目として継ぐ。 「機械と魔導の融合は、 観測者七座の手にすら届かぬ場所まで届く」——ヴァーレ女皇の千年血脈の祈りを、 メリディアの艦隊指揮が、 戦場全体に広げる。" },
    { title: "リガン機械兵への育成", body: "メリディアは、 空挺機械兵リガン (s1c7 SR) を、 千年血脈の艦隊兵の継承者として育てている。 リガンは、 まだ二十一歳の若き機械兵だが、 蒸気砲の操縦感覚は、 既にメリディアを驚かせる才能。 「お前が、 千年血脈の艦隊兵の次世代を担う」——メリディアがリガンに、 静かに告げた言葉。 千年職能の継承は、 戦場の中で、 静かに進んでいく。" },
  ],
  "SSR_銀霜神官長 ヴィルニル": [
    { title: "ノヴァ王の精神的支柱", body: "ヴィルニルは、 銀霜王ノヴァ (s1c5 SSR) の精神的支柱として、 千年血脈の神官長の役を担う。 月夜祭司アスター (s1c5 SR) より上位の「神官長 = 雪月神殿最高位」 として、 銀霜の宗教面の頂点。 「銀霜の月よ、 王の道を照らせ」——ヴィルニルの千年血脈の祈り。 ノヴァ王の若き肩の重みを、 ヴィルニルの祈りが、 静かに支える。" },
    { title: "雪月神殿千年血脈の神官", body: "ヴィルニルの月の杖は、 千年前の雪月神殿の創始神官から、 千年継承された聖具。 千年同じ杖を、 同じ祭壇で、 代々の神官たちが同じ祈りを捧げ続けてきた。 黒月決戦中も、 ヴィルニルは雪月神殿で祈祷を捧げ続ける支援役。 銀霜陣営の戦力の半分は、 ヴィルニルの祈りで支えられている。" },
    { title: "シオンとの千年血脈の盾の絆", body: "ヴィルニルは、 仮面騎士シオン (s1c5 SSR 沈黙の盾) と、 千年血脈の盾の絆を共有する。 シオンが「声を捨てた」 騎士、 ヴィルニルが「言葉で祈る」 神官——二人は、 銀霜陣営の二つの柱として、 千年血脈の沈黙と祈りを、 共に担う。 「シオン様の沈黙が、 千年血脈の盾の祈りと、 同じ重みを持つ」——ヴィルニルの千年血脈の認識。" },
  ],
  "SSR_巫女連邦軍師 セイラン": [
    { title: "ホムラとの千年血脈の盟友", body: "セイランは、 鳳神巫女ホムラ (s1c6 UR) と、 千年血脈の盟友関係。 ホムラが戦場の前衛で剣を振るうのに対し、 セイランは戦略担当として全派閥連携の中枢を担う。 「戦場の図を、 七色に塗り直しましょう」——セイランの千年血脈の祈り。 ホムラの千年警護とセイランの千年戦略が、 巫女連邦リーリエの戦力を、 戦場全体に広げる。" },
    { title: "七色の作戦扇子の千年血脈", body: "セイランの七色の作戦扇子は、 千年前の巫女連邦リーリエの初代軍師から、 千年継承された聖具。 千年同じ扇子を、 戦場ごとに代を継ぎ、 同じ祈りで振るわれてきた。 黒月決戦で、 セイランの作戦扇子は、 全派閥の戦力配置を、 七色の light-particle で示した。 千年血脈の戦略担当の祈りが、 戦場全体の連携を、 静かに支えていた。" },
    { title: "イリス第四席の戦略支援", body: "セイランは、 イリス (s1c6 UR 第四席「約束」) の戦略支援役を担う。 イリスが千年血脈の祈りを担うのに対し、 セイランが戦場の戦略を担う——二つの千年血脈の担い手が、 巫女連邦リーリエの戦力を、 戦場全体に広げる。 「イリス様の千年血脈の祈りを、 戦場の戦略に織り込みます」——セイランの千年血脈の認識。" },
  ],
  "SSR_異界塔執行官 オブスクル": [
    { title: "ザナディア塔主への忠誠", body: "オブスクルは、 ザナディア塔主 (s1c7 UR) に仕える若き執行官、 二十七-二十八歳。 千年閉じ込められた塔がようやく動き始めた今、 ザナディアの千年祈りを剣で支える役を担う。 「塔の意志を、 剣で執行する」——オブスクルの祈り。 黒月決戦の戦場で、 オブスクルの剣は、 ザナディア塔主の千年祈りを、 戦場の中央で、 静かに具現化していた。" },
    { title: "若き執行官の鍛錬", body: "オブスクルは、 voidtower の鍛錬場で、 ザナディアの傍で稽古を重ねてきた。 void-black の longsword は、 千年前にザナディアが鋳造した、 voidtower の聖具——その聖具を背負うに足る剣才と認められ、 ザナディア配下の最も若い総大将に登った。 黒月決戦で、 オブスクルの剣は、 千年の塔の意志を背負う重みで、 観測者陣営の戦士たちと拮抗していた。" },
    { title: "「共に在る」 への気付き", body: "アルテミス陛下の「共に在る、 が答えだ」 という言葉に、 オブスクルは初めて、 longsword の柄を強く握った。 千年閉じ込められた塔の意志を「執行する」 と教えられてきたオブスクルにとって、 「共に在る」 という言葉は、 想定外の答えだった。 「執行とは、 そういう意味か」——オブスクルの認識の転換点。 千年の塔の意志を背負ってきた執行官が、 千年祈りの意味を、 戦場の中央で、 ようやく理解する瞬間だった。" },
  ],
  // SR10 凸秘話 (Lv.2〜Lv.3、 各2本) — 第三-五幕完成と並行で追加
  "SR_教会の盾 リーラ": [
    { title: "ラナス先輩への憧れ", body: "リーラは、 ラナス先輩 (s1c2 SR 教会騎士) への憧れで、 教会騎士の道を選んだ。 千年血脈の盾の系譜の若き継承者。 黒月決戦の戦場で、 リーラの大型タワーシールドは、 ラナスの盾と並んで、 教会陣営の前線を、 静かに支えていた。 「ラナス先輩の隣で、 戦えるなんて、 千年血脈の盾の継承者として、 何より誉れ」——リーラの祈り。" },
    { title: "リサとの戦場の絆", body: "リーラは、 戦場救護のリサ (R) と、 千年血脈の盾の絆を共有する。 リーラが盾で前線を守り、 リサが治癒で後方を支える——二人の若き教会人の連携が、 戦場の縁で、 千年血脈の祈りを結実させる。 「リサ、 後ろは大丈夫だから、 治癒に専念して」——リーラがリサに告げた、 戦場の信頼の言葉。" },
  ],
  "SR_海淵射手 シャラ": [
    { title: "海中射撃の特殊技", body: "シャラの海中射撃は、 アクアシス長弓兵の千年血脈の系譜。 千年同じ弓を、 千年同じ海溝で、 千年同じ精度で射続けた。 黒月決戦の戦場で、 シャラの弓は、 海面と海中の両方から、 異界塔戦士団の隊列を、 千年血脈の精度で射抜いた。 「波の中の標的、 射程に入った」——シャラの戦場での号令。" },
    { title: "ナイアス神官への信仰", body: "シャラは、 アクアシス海神官ナイアス (s1c7 SSR) を、 千年血脈の信仰の対象として、 静かに敬う。 ナイアスの祈りが、 シャラの弓の精度を、 千年血脈の精度に高める——「海の祈りが、 弓の動きを導く」——シャラの千年血脈の認識。" },
  ],
  "SR_古龍鎧の戦士 ガロン": [
    { title: "グラン師匠の弟子", body: "ガロンは、 古龍砂漠サハールの千年血脈剣師グラン (s1c3 SR 砂牙の剣聖) の若き弟子。 千年血脈の鱗の鎧を纏い、 グラン師匠の剣の癖を、 千年血脈の継承の作法で、 学んでいる。 黒月決戦の戦場で、 ガロンの剣は、 グラン師匠の千年血脈の剣戟を、 静かに具現化していた。" },
    { title: "古龍王覚醒への期待", body: "ガロンは、 古龍王覚醒の予兆を、 千年血脈の鱗の鎧で感じている。 ファラー (s1c3 UR) と アグル (s1c7 SSR) が呼び出す古龍王の半透明の竜の影に、 ガロンの鎧が、 微かに、 共鳴していた。 千年血脈の鱗の鎧の継承者として、 ガロンは古龍王覚醒の朝を、 静かに、 待っている。" },
  ],
  "SR_氷塔の魔導士 セレスタ": [
    { title: "ノエル魔導長の弟子", body: "セレスタは、 氷霊魔導長ノエル (s1c7 SSR) の若き弟子。 千年血脈の氷魔法の継承者として、 戦場の北東で、 ノエルの傍に立った。 「お前が、 千年血脈の魔導士の次世代を担う」——ノエルがセレスタに告げた、 千年血脈の継承の言葉。" },
    { title: "ユーリス予言の補佐", body: "セレスタは、 氷霜の巫女ユーリス (s1c4 UR) の予言の補佐役も担う。 ユーリスの予言を、 戦場の魔法戦術に翻訳する役。 「予言を、 魔法戦術に織り込みます」——セレスタの千年血脈の祈り。" },
  ],
  "SR_空挺機械兵 リガン": [
    { title: "ヴァーレ女皇への信仰", body: "リガンは、 ヴァーレ女皇 (s1c4 UR) を、 千年血脈の信仰の対象として、 戦場で静かに敬う。 「ヴァーレ女皇の機械文明の道は、 千年血脈の信仰の道」——リガンの戦場での認識。 千年血脈の機械兵の継承者として、 リガンの蒸気銃は、 ヴァーレの千年祈りを、 戦場の中央に、 静かに具現化していた。" },
    { title: "メリディア艦隊長の指揮下", body: "リガンは、 空挺艦隊長メリディア (s1c7 SSR) の指揮下で、 千年血脈の艦隊兵の系譜を継ぐ。 「お前が、 千年血脈の艦隊兵の次世代を担う」——メリディアがリガンに告げた、 千年血脈の継承の言葉。" },
  ],
  "SR_銀霜の若騎士 ライオン": [
    { title: "セレン先輩への憧れ", body: "ライオンは、 セレン先輩 (s1c5 SR 銀霜近衛) への憧れで、 銀霜近衛の道を選んだ。 千年血脈の盾の系譜の若き継承者。 「セレン先輩、 私が王宮を守ります!」——ライオンの戦場での号令。 月夜祭の警護役として、 千年血脈の銀霜近衛の継承者の務めを、 静かに、 果たし続ける。" },
    { title: "ノヴァ王への信仰", body: "ライオンは、 銀霜王ノヴァ (s1c5 SSR) を、 千年血脈の信仰の対象として、 戦場で静かに敬う。 「ノヴァ王の若き肩の重みを、 千年血脈の銀霜近衛が、 静かに支える」——ライオンの千年血脈の認識。" },
  ],
  "SR_異界塔の闇衛 ノクサル": [
    { title: "目覚めた塔の若き闇衛", body: "ノクサルは、 千年閉じ込められた異界塔ザナドの中で 静かに育ってきた若き闇衛、 二十一-二十二歳。 塔がようやく動き始めた今、 voidtower 戦士団の前線兵として、 黒月決戦の戦場に立つ。 黒月決戦で、 ノクサルの void-black halberd は、 オブスクル (s1c7 SSR 執行官) 配下の前線兵として、 千年の塔の意志を背負う祈りを、 静かに、 具現化していた。" },
    { title: "オブスクル執行官への忠誠", body: "ノクサルは、 オブスクル執行官に忠誠を捧げる若き闇衛。 「塔の意志を、 我が刃で守る」——ノクサルの祈り。 千年の塔の祈りを継ぐ若き闇衛として、 ノクサルの剣は、 観測者陣営の戦士たちと、 静かな重みで、 拮抗していた。" },
  ],
  "SR_異界塔の魔導兵 アビス": [
    { title: "目覚めた塔の若き闇魔導士", body: "アビスは、 千年閉じ込められた異界塔ザナドの中で 影の咒術を学んできた若き闇魔導士、 二十-二十一歳。 塔がようやく動き始めた今、 千年の祈りを引き継いで戦場に立つ。 「影の咒術を、 解き放つ」——アビスの祈り。 黒月決戦の戦場で、 アビスの void mage staff は、 凍土陣営との魔法戦の前線で、 千年継承された咒術を、 静かに、 具現化していた。" },
    { title: "ノエル魔導長との対決", body: "アビスは、 氷霊魔導長ノエル (s1c7 SSR) と、 千年血脈の魔導士同士の対決を演じた。 千年継承の氷魔法 vs 千年継承の闇咒術——伝統同士の対決が、 戦場の北東で、 静かに繰り広げられた。 アビスの咒術は、 ノエルの氷魔法に完全に中和されたが、 二人の対決は、 二系譜の祈りの結実だった。" },
  ],
  "SR_異界塔の斥候 グリム": [
    { title: "影の中を歩く若き偵察兵", body: "グリムは、 千年閉じ込められた異界塔ザナドの中で 影の中を歩く術を学んできた若き斥候、 二十-二十一歳。 塔がようやく動き始めた今、 戦線の情報伝達役として黒月決戦に立つ。 「影は、 私の足跡を消してくれる」——グリムの祈り。 千年継承された斥候の作法を、 若き身で受け継ぐ。" },
    { title: "シ・ロエン接触の前哨偵察", body: "グリムは、 黒月決戦の前夜、 シ・ロエン (s1c5 UR) との接触の前哨偵察を担った。 ウンブリス (s1c7 UR 影使徒) の指揮下で、 シ・ロエンの存在を、 戦場の縁で、 静かに、 偵察した。 「影の千年職能の継承者として、 シ・ロエンの存在を、 静かに、 見届けます」——グリムの千年血脈の祈り。" },
  ],
  "SR_共観の補佐 ニュトラル": [
    { title: "ジュンクトス師匠の弟子", body: "ニュトラルは、 共観の使徒ジュンクトス (s1c7 UR) の若き弟子。 千年級の修行を始めたばかり、 二十-二十一歳。 「あなたも、 千年、 両方を観るのですよ」——ジュンクトスがニュトラルに掛ける、 唯一の指導の言葉。 ニュトラルは、 ジュンクトス師匠の千年の修行を、 引き継ぎ始めている。" },
    { title: "S2C7 接続の儀での再登場", body: "ニュトラルは、 S2C7「接続の儀」 で再登場予定。 ジュンクトス師匠の傍で、 共観の儀式進行役を、 千年血脈の使徒として、 静かに担う。 「両方を観る」 から「全てを観る」 へ——千年級存在の祈りの最終形態を、 ニュトラルも、 千年血脈の継承者として、 学び続ける。" },
  ],
  // R5 凸秘話 (Lv.2、 各1本) — 第三-五幕完成と並行で追加
  "R_異界塔の伝令 ヴィタ": [
    { title: "影の翼で空を飛ぶ若き伝令", body: "ヴィタは、 異界塔ザナドの若き伝令、 十八-十九歳。 影の翼で空を飛び、 voidtower 戦士団の各戦線に塔主の意志を届ける。 「塔の意、 全戦線へ届けます!」——ヴィタの戦場での号令。 千年閉じ込められた塔の若き伝令の継承者として、 千年祈りの言葉を、 戦場の各陣営に、 静かに、 運び続ける。" },
  ],
  "R_異界塔の鍛冶 ザイ": [
    { title: "千年閉じ込められた forges を再び動かす", body: "ザイは、 異界塔ザナドの若き鍛冶、 十八-十九歳。 千年閉じ込められた塔の forges を、 ようやく、 再び動かす一人。 obsidian の anvil で void 武具を作り、 千年閉じ込められた使徒たちと戦士たちの剣を、 千年血脈の鍛冶の作法で、 千年ぶりに、 修復し続けた。" },
  ],
  "R_異界塔の歌手 メル": [
    { title: "千年祈祷歌の若き継承者", body: "メルは、 異界塔ザナドの若き歌手、 十八-十九歳。 void singer として、 千年閉じ込められた塔に伝わる祈祷歌を、 先代の歌手から受け継いで歌い続けてきた。 メルの歌声は、 voidtower 派閥 BGM の vocalize 担当として、 戦場全体に、 千年継承された祈りの音を、 静かに、 響かせていた。" },
  ],
  "R_戦場の救護 リサ": [
    { title: "戦場で負傷者を助ける若き救護担当", body: "リサは、 白焔教会の若き救護担当、 十八-十九歳。 戦場で負傷者を助ける救護役として、 healing wand と bandages で前線兵を治す。 「立てますか? 私が、 ここにいます」——リサの戦場での祈り。 千年血脈の教会の救護担当の継承者として、 戦場の縁で、 静かに、 千年祈りの治癒を、 全派閥の戦士たちに、 届け続けた。" },
  ],
  "R_戦場の伝令 タイ": [
    { title: "全派閥間を駆ける若き伝令", body: "タイは、 第七天の若き伝令、 十八-十九歳。 全派閥間を駆けて連絡を担う、 派閥連携の象徴。 「全派閥の旗、 全部見届けてやる!」——タイの戦場での号令。 千年血脈の派閥連携の若き継承者として、 黒月決戦の戦場で、 全派閥の戦士たちの間を、 千年祈りの連絡網として、 静かに、 駆け抜けていた。" },
  ],
};
...
const CHAR_FACTION = {
  ...
  '楽巫女 イオナ':                { f: 'shrines', dx: -130, dy:   80 },  // 中下左 (楽)
  '双子巫女姉 ノエラ':            { f: 'shrines', dx:  -50, dy:  100 },  // 中下中左 (双子姉)
  '双子巫女妹 アシナ':            { f: 'shrines', dx:   50, dy:  100 },  // 中下中右 (双子妹)
  '月読み祭司 オリオン':          { f: 'shrines', dx:  130, dy:   80 },  // 中下右 (天文)
  '神殿護衛戦士 ガレフ':          { f: 'shrines', dx:  -90, dy:  170 },  // 下左 (戦士)
  '七座楽人 ハルナ':              { f: 'shrines', dx:    0, dy:  170 },  // 下中央 (楽人)
  '灯篭職人長 コノエ':            { f: 'shrines', dx:   90, dy:  170 },  // 下右 (職人)
  '医療巫女 メア':                { f: 'shrines', dx: -160, dy:  240 },  // 最下左 (医療)
  '高巫女見習い カヤ':            { f: 'shrines', dx:  160, dy:  240 },  // 最下右 (見習い高位)
  '巫女見習い アヤメ':            { f: 'shrines', dx: -180, dy:  320 },  // R 左外
  '巫女見習い スズ':              { f: 'shrines', dx:  -60, dy:  320 },  // R 中左
  '巫女見習い ハナ':              { f: 'shrines', dx:   60, dy:  320 },  // R 中右
  '巫女見習い ユウ':              { f: 'shrines', dx:  180, dy:  320 },  // R 右外
  '楽人見習い ハジメ':            { f: 'shrines', dx:  -50, dy:  390 },  // R 最下左
  '灯篭職人見習い リル':          { f: 'shrines', dx:   50, dy:  390 },  // R 最下右
  // ===== S1C7 追加 (異界の塔ザナド voidtower + 9派閥旗手 + 中立) =====
  // voidtower 派閥 (13体所属、 LR1+UR4+SSR1+SR4+R3、 voidtower 中心 x:1000, y:1580 を中央に密集なく配置)
  '虚意 ヴォイドラ':              { f: 'voidtower', dx:    0, dy: -240 },  // LR 最上 (世界格)
  '塔主 ザナディア':              { f: 'voidtower', dx: -180, dy: -150 },  // UR 上左
  '影使徒 ウンブリス':             { f: 'voidtower', dx:  180, dy: -150 },  // UR 上右
  '黒月使徒 テネブラ':             { f: 'voidtower', dx: -180, dy:  -50 },  // UR 中左
  '共観の使徒 ジュンクトス':       { f: 'voidtower', dx:  180, dy:  -50 },  // UR 中右 (中立扱いだが派閥配置)
  '異界塔執行官 オブスクル':       { f: 'voidtower', dx:    0, dy:  -50 },  // SSR 中央
  '異界塔の闇衛 ノクサル':         { f: 'voidtower', dx: -160, dy:   70 },  // SR 下左
  '異界塔の魔導兵 アビス':         { f: 'voidtower', dx:  -50, dy:   70 },  // SR 下中左
  '異界塔の斥候 グリム':           { f: 'voidtower', dx:   50, dy:   70 },  // SR 下中右
  '共観の補佐 ニュトラル':         { f: 'voidtower', dx:  160, dy:   70 },  // SR 下右
  '異界塔の伝令 ヴィタ':           { f: 'voidtower', dx: -120, dy:  170 },  // R 最下左
  '異界塔の鍛冶 ザイ':             { f: 'voidtower', dx:    0, dy:  170 },  // R 最下中央
  '異界塔の歌手 メル':             { f: 'voidtower', dx:  120, dy:  170 },  // R 最下右
  // 9派閥旗手 SSR (各派閥に既存配置に合わせて配置)
  '白焔聖騎士団長 オーレン':       { f: 'church',  dx: -140, dy:    0 },
  '教会の盾 リーラ':               { f: 'church',  dx:  170, dy:  170 },
  '戦場の救護 リサ':               { f: 'church',  dx:    0, dy:  200 },
  'アクアシス海神官 ナイアス':     { f: 'aquasis', dx:    0, dy:  170 },
  '海淵射手 シャラ':               { f: 'aquasis', dx:  -50, dy:  220 },
  '紅玉旗艦砲手長 マロン':         { f: 'crimson', dx:    0, dy:  150 },
  '古龍王の使者 アグル':           { f: 'sahar',   dx:  100, dy: -200 },
  '古龍鎧の戦士 ガロン':           { f: 'sahar',   dx:  170, dy:  170 },
  '氷霊魔導長 ノエル':             { f: 'niiruru', dx: -160, dy:  170 },
  '氷塔の魔導士 セレスタ':         { f: 'niiruru', dx:  -55, dy:  220 },
  '空挺艦隊長 メリディア':         { f: 'zenonia', dx: -160, dy:  170 },
  '空挺機械兵 リガン':             { f: 'zenonia', dx:    0, dy:  220 },
  '銀霜神官長 ヴィルニル':         { f: 'silver',  dx:  130, dy: -150 },
  '銀霜の若騎士 ライオン':         { f: 'silver',  dx:  130, dy:  170 },
  '巫女連邦軍師 セイラン':         { f: 'shrines', dx: -250, dy:  170 },  // R見習い群と離す
  // 中立 (沈黙候補は genso、 戦場伝令は seventh)
  '沈黙の候補 ミューティス':       { f: 'genso',   dx: -180, dy:  180 },  // genso 中央 + 補助 (七座候補)
  '戦場の伝令 タイ':               { f: 'seventh', dx:    0, dy:  120 },
};
...
const RELATIONS = [
  ...
  { a: '主祭 リアラ',                  b: '月読み祭司 オリオン',      type: 'fellow',    label: '天文・暦の祭司同士' },                        // 4-1 儀式
  { a: '楽巫女 イオナ',                b: '七座楽人 ハルナ',          type: 'fellow',    label: '七座祭楽の同胞' },                            // 4-1 儀式
  { a: '楽巫女 イオナ',                b: '楽人見習い ハジメ',        type: 'master',    aRole: '楽の師', bRole: '見習い' },                   // 楽人見習い 弟子
  { a: '双子巫女姉 ノエラ',            b: '双子巫女妹 アシナ',        type: 'blood',     label: '双子の姉妹' },                                // 1-3 灯篭祭
  { a: '双子巫女姉 ノエラ',            b: 'イリス',                   type: 'childhood', label: '幼馴染 (同21歳)' },                           // 2-3 リーリエ告白の回想
  { a: '双子巫女妹 アシナ',            b: 'イリス',                   type: 'childhood', label: '幼馴染 (同21歳)' },                           // 1-3 灯篭祭
  { a: '神殿護衛戦士 ガレフ',          b: '鳳神巫女 ホムラ',          type: 'master',    aRole: '直属隊長', bRole: '師' },                     // 3-1 警護隊
  { a: '灯篭職人長 コノエ',            b: '灯篭職人見習い リル',      type: 'master',    aRole: '工房長', bRole: '見習い' },                   // 1-3 灯篭工房
  { a: '医療巫女 メア',                b: '鳳神巫女 ホムラ',          type: 'fellow',    label: '戦士たちの怪我を預かる癒し手' },              // 1-3 医療所
  { a: '巫女見習い アヤメ',            b: '高巫女見習い カヤ',        type: 'fellow',    label: '見習い同期' },                                // 同期
  { a: '巫女見習い スズ',              b: '高巫女見習い カヤ',        type: 'fellow',    label: '見習い同期' },                                // 同期
  ...
  // 古龍王陣営
  { a: '古龍王の使者 アグル',          b: '古龍の語り部 ファラー',     type: 'master',    aRole: '使者', bRole: '語り部 (千年血脈の先達)' },
...
const _firstLoginBtn = document.getElementById('first-login-banner');
...
const STORY_FILES = {
  ...
  s1c7: { title: '黒月決戦',     meta: 'Season 1 — 第7章', file: 'content/story/s1c7.md' },
};
...
const FURIGANA = {
  ...
  '沈黙の候補': 'ちんもくのこうほ',
  '沈黙': 'ちんもく',
  '白焔聖騎士団長': 'はくえんせいきしだんちょう',
  '聖騎士団長': 'せいきしだんちょう',
  'アクアシス海神官': 'あくあしすかいしんかん',
  '海神官': 'かいしんかん',
  '紅玉旗艦砲手長': 'こうぎょくきかんほうしゅちょう',
  '旗艦砲手長': 'きかんほうしゅちょう',
  '砲手長': 'ほうしゅちょう',
  '古龍王の使者': 'ころうおうのししゃ',
  '古龍王': 'ころうおう',
...
const STORY_ACT_INTROS = {
  ...
  's1c7': {
    'Season 1 第7章 — 黒月決戦 (Season 1 最終章)': '千年の対の存在と、 ようやく言葉を交わす夜。 影を消すのではなく、 共に在ると認める。\n— 虹意 プリズマ',
    '第一幕 — 黒月の覚醒':              '西の空に、 黒い月が昇る。 千年閉じ込めていた者が、 今、 戻ってくる。\n— プリズマ',
    '第二幕 — 全派閥総力戦':            '北から、 南から、 砂漠から、 空から。 千年の友が、 同じ戦場に立ってくれる。\n— プリズマ',
    '第三幕 — 鏡像の再会':              'もう一人の影と、 もう一人の光が、 戦場の中央で静かに頷き合う夜。\n— プリズマ',
    '第四幕 — 共観の対話':              '塔の頂で、 私は千年の対の存在と、 初めて目を合わせる。 影を消すのではなく、 共に在ると認める。\n— プリズマ',
    '第五幕 — 眠りに入る者':            '光を次の世代に託す日。 私は、 静かに眠りに就く。\n— プリズマ',
    'エピローグ — 接続の時代へ':        '千年の旅の、 ひとつの結び——そして、 接続の時代へ。\n— プリズマ',
  },
};
...
const STORY_LOCATION_INLINE_CONFIG = {
  ...
  's1c2': [
    ...
    // 第二幕 2-3 アクアシス宮殿 (旧 4-1 → 2-3): 海上 (entrance) → 海中 (city背景) → 宮殿 (throne) の進行    { scene: '2-3',  marker: '宮殿の謁見の間',                    position: 'before', img: '/images/locations/s1c2/thumb/aquasis_throne_thumb.webp' },
    // 第三幕 3-3 波紋の聖女 (旧 5-3 → 3-3): 覚醒の絶頂を挿絵で (キャラカットイン削除)
    { scene: '3-3',  marker: '光の中で私の鎧が変容した',      position: 'after',  img: '/images/locations/s1c2/thumb/ripple_saint_awakening_thumb.webp' },
  ],
  's1c4': [
    // 第4章 挿絵 (16:9横、 全 8枚)
    ...
    { scene: '3-2',  marker: '機関士のジンが船の蒸気管を絶え間なく整備しながら',  position: 'after',  img: '/images/locations/s1c4/thumb/ice_shadeova_battle_thumb.webp' },
  ...
  's1c5': [
    ...
    { scene: '4-1',  marker: '月鏡に俺の素顔が映った',                            position: 'after',  img: '/images/locations/s1c5/thumb/mask_unveil_moment_thumb.webp' },
...
function _getEffectiveVersion(data) {
  ...
  // lastDevSuffix 結合の理由: scheduled モードで dev が 1.5.0g (suffix 進行中) の時、
...
// ====== 初回アクセス時のアカウント登録案内 (v1.5.0g〜 account-prompt に統一) ======
