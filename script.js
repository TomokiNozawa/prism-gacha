/* ============================================================
   Prismaera v1.5.1az — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    },
    {
      ...
      caption: "私は、 七座入りを千年辞退してきた。 鳳神の薙刀は、 地上で警護を続ける。",
    ...
    },
    {
      ...
      desc: "ヴォイドラ陣営の若き影の使徒。 シ・ロエン (s1c5、 シオン分離後の影) とは別系統の影 = 元から影として生まれた使徒。 漆黒の単刃曲剣、 半割れの violet-edge 仮面。 シ・ロエンに「異界塔ザナドへの誘い」 を持ちかける役割。 シオン×シ・ロエン再会の前夜にもう一つの影として戦場に立つ、 黒月衆ノクトリアとは別陣営の voidtower 直属。",
...
const LORE_BY_KEY = {
  ...
  "UR_影使徒 ウンブリス": [
    { title: "シ・ロエンとの「同胞」 認識", body: "ウンブリスは元から「影として生まれた」 使徒——シ・ロエン (s1c5、 シオン分離後の影) とは別系統の影。 だが、 「影の格」 を共有する点では、 同じ。 シ・ロエンが千年前に黒月衆へ去った時、 ウンブリスは千年閉じ込められたまま、 シ・ロエンの存在を遠くから感じていた。 「我が同胞よ」——ウンブリスがシ・ロエンに掛ける最初の言葉。 同じ影の格、 だが別の道を歩んだ二人の影が、 黒月決戦の前夜に、 初めて言葉を交わす。" },
    ...
    { title: "シ・ロエン接触の役目", body: "黒月決戦の前夜、 ウンブリスはシ・ロエンに接触する役を担った。 「あなたが——銀霜の側に立つ理由が、 まだ残っているのなら」——ウンブリスの問い。 シ・ロエンは静かに微笑んで、 「私の道は、 自分で選ぶ」 と答えた。 ウンブリスは深く頷き、 影に溶けて消えた。 二人の影は、 千年違う道を歩んだ後、 黒月決戦の戦場で、 初めて並ぶ。 そして、 戦の後——ウンブリスは、 シ・ロエンと共に、 新しい世界の影として動く。" },
...
const IMG_CACHE_VERSION = '1.5.1az';
