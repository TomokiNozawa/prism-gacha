/* ============================================================
   Prismaera v1.5.1be — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    // ===== S1C6 追加 (UR3、 巫女連邦リーリエ — 七座満つる) =====
    {
      ...
      desc: "巫女連邦リーリエの若き代表巫女、 二十一歳。 千年血脈の最新の枝として、 観測者七座の第四席「約束」 (緑) に座する若き同胞。 母ヴィオレナは千年前に第四席候補を辞退し「私の娘が千年後に代わりに座る」 と告げた。 その約束を、 千年経って、 イリス自身の千年として始める。 七色の灯篭の杖を持ち、 千年祭祀の継承を担う。",
      img: `${S1}/ur/iris.png`,
    },
    {
      ...
      desc: "巫女連邦リーリエの長老巫女、 千年級存在。 見た目は二十代後半、 千年前に第四席候補を辞退し「娘の代に灯る」 と決めた若き母。 リオラエル殿 (s1c5、 地底市) と同時代を生き、 月影宮で共に祈った夜の記憶を持つ。 紫銀の長髪、 紫水晶の瞳、 七色の二重玉を頂く杖。 千年前のヴィオレナと月影宮で交わした「私の千年は、 ここで娘を育てる」 の誓いを、 千年経って完遂した。",
      img: `${S1}/ur/shrine_oracle.png`,
    },
    {
      name: "鳳神巫女 ホムラ", season: 1, chapter: 's1c6',
      title: "巫女連邦最強の戦巫女、 七座警護の頂点格",
      caption: "鳳神巫女は、 七座入りを千年辞退してきた。 私の代も、 地上で警護を続ける。",
      desc: "巫女連邦リーリエの戦巫女最高峰、 二十七歳。 朱赤の髪を高く編み上げ、 七色の鳳の羽根を象嵌した薙刀を振るう。 千年前から代々続く鳳神巫女の血脈、 過去三代も第五席「連結」 候補に名が挙がるが「警護の千年職能は天上より地上に必要」 と全て辞退してきた。 イリスの剣の師、 同時に十五年共に育った姉のような存在。 ヒノオウ (UR、 焔帝) の朱の鳳凰と並列の千年職能を担う。",
  ...
  SSR: [
    ...
    // ===== S1C6 追加 (SSR4、 巫女連邦リーリエ — 七座満つる) =====
    {
      ...
      caption: "次の代に、 灯ります。",
      desc: "巫女連邦リーリエの大巫女、 三十代前半。 千年伝承の継承役で、 イリス (UR) の幼少期からの指導者。 銀髪に翡翠の先端、 翡翠の宝石の額飾り、 銀の杖を持つ。 千年祭祀の歴代の祈祷文を全て暗誦できる、 巫女連邦の生きた記憶。",
    ...
    },
    {
      ...
      caption: "七座、 四つ満ちる。",
      desc: "巫女連邦リーリエの主祭、 二十代後半。 七色の星図を映す水晶玉を扱い、 観測者七座の儀式を進める儀典官。 紺青の長髪、 銀青の瞳、 星座と七色を縫い込んだ祭祀の衣。 イリスの七座着座儀式を、 千年に一度の儀典として執り行った。",
    ...
    },
    {
      ...
      desc: "巫女連邦リーリエの楽巫女、 二十代前半。 七弦の神聖な琴 (七色対応) を操り、 灯篭祭の神楽演奏を司る。 金髪に七色のハイライト、 ハシバミ色の瞳、 銀金の祭祀の衣。 七座儀式の祭楽を担当、 千年祭祀の音色を継承する一族。",
  ...
  SR: [
    ...
    },
    {
      ...
      title: "千年祭の七色灯篭を継ぐ職人頭",
      caption: "灯篭は、 灯し直すから、 灯篭なのです。",
      desc: "巫女連邦リーリエの灯篭職人長、 三十八歳。 焦茶の高結びの髪に七色の絹リボン、 ハシバミ色の瞳、 工房用の作業衣。 千年祭祀の七色紙灯篭を製作する一族の頭。 「灯篭が消えた村跡」 にも月一で巡礼に行き、 千年経っても灯し直す祈りを継ぐ。",
    ...
    },
    {
      ...
      title: "大巫女ヴィーナの直弟子",
      caption: "千年伝承を、 暗誦できるようになります。",
      desc: "巫女連邦リーリエの高巫女見習い、 十八歳。 翡翠銀の長髪を片サイドポニーで結び、 真剣な翡翠の瞳。 大巫女ヴィーナ (SSR) の直弟子として、 千年祭祀の継承を学ぶ若き候補。 巫女連邦次世代候補の代表格。",
  ...
  R: [
    ...
    },
    {
      ...
      desc: "巫女連邦リーリエの灯篭職人見習い、 十五歳。 焦茶の短髪に七色の糸の三つ編み、 ハシバミ色の瞳。 コノエ (SR、 灯篭職人長) の弟子、 千年祭の灯篭を継ぐ若き手。",
...
const LORE_BY_KEY = {
  ...
  "UR_イリス": [
    { title: "千年血脈の自覚", body: "イリスは物心ついた頃から、 母ヴィオレナに「お前は約束を守るために生まれた」 と告げられて育った。 千年前、 母が第四席を辞退した夜の話を、 何度も聞かされた。 七歳の冬、 イリスは初めて母に問うた——「私は、 私自身の人生を、 持っているのですか?」。 母は、 静かに微笑み、 こう答えた——「その問いを、 自分で見つけることが、 あなたの千年です」。 イリスは、 その答えを、 二十一年抱えて生きてきた。 そして、 セラフィエル様の招待状を受け取った夜、 ようやく、 答えの最初の一頁を、 自分の手で開いた。" },
    { title: "セラフィエル様との初対面", body: "灯篭祭の夜、 街路の上空からセラフィエル様が降りてこられた瞬間、 イリスは膝をつかなかった。 母から「観測者七座は、 同列の同胞だ。 仰ぎ見る相手ではない」 と教えられていたから。 セラフィエル様は、 真っ直ぐにイリスの眼を見て、 「面を上げよ、 イリス。 あなたは、 既に、 私と同じ高さに立つ者なのです」 と告げた。 イリスは、 その時、 千年血脈の意味が——「同等の存在として迎えられる準備」 だったのだと、 初めて理解した。 千年待った母の祈りは、 イリス自身の千年の入口だった。" },
    { title: "「私自身の千年」 の始まり", body: "月夜の祈祷の塔で、 イリスはセラフィエル様に告白した——「自分が母の千年の延長線上にしか存在していないのではないか」 と。 セラフィエル様は、 千年前ご自身がプリズマ様に「最初の羽」 として生まれた夜の話をしてくださった。 「翼を一枚、 静かにたたんだ夜があった。 それは、 『私はまだ飛べる』 という、 最も静かな返事でした」。 イリスは、 その夜、 自分の中で、 母の千年と並ぶ「もう一つの千年」 が、 静かに灯り始めるのを感じた。 母の祈りの続きではなく、 自分自身の祈りの始まり。" },
    { title: "七座の同胞として", body: "月影宮の七座儀式の夜、 イリスは第四席に腰を下ろした瞬間、 卓の七つの同心円のうち緑の環が、 千年ぶりに灯った。 三柱は、 イリスを「妹」 ではなく「同胞」 として迎えた。 イリスは、 観測者の最初の言葉として、 こう告げた——「『違っていても、 同じ目的を持つ仲間でいられる』」。 カグヤ様は微笑み、 ノクス様は頷き、 セラフィエル様は翼を半分広げた。 そして、 ノクス様が静かに呟いた——「これでも、 足りない」。 イリスは、 その夜、 自分が「迎える側」 になる千年が、 既に、 始まっていることを知った。" },
  ],
  "UR_千年語り ヴィオレナ": [
    { title: "千年前の決断", body: "千年前のある夜、 ヴィオレナは月影宮に呼ばれた。 観測者七座の第四席「約束」 の候補として、 セラフィエル様が直々に招きに来てくださった夜だった。 ヴィオレナは、 月光の下で深く礼をし、 静かに首を横に振った——「私は、 まだ、 地上にいたいのです」。 「私の娘が、 千年後に、 私の代わりにここへ来ます」。 二十代後半のヴィオレナは、 その時、 まだ娘を産んでいなかった。 けれど、 千年血脈の最後の枝が、 千年後にどんな娘を生むのか——その確信だけは、 既に、 彼女の胸の奥にあった。 千年前の自分との約束を、 千年経った今、 イリスの代に、 ようやく、 灯した。" },
    { title: "リオラエル殿との千年前", body: "千年前、 月影宮で第四席候補の招きを受けた夜、 ヴィオレナは一人ではなかった。 同じ夜に、 もう一人の若き巫女——リオラエル殿——が、 観測者の招きを断りに来ていた。 リオラエル殿は「影と共に生きる選択をする」 と告げ、 地底市リオラの民を率いる道を選んだ。 ヴィオレナは「千年後に娘を立たせる」 と告げた。 二人の若き巫女が、 月影宮の縁で、 共に七色の灯篭を灯した。 千年前のあの夜、 ヴィオレナとリオラエル殿は、 「観測者の前から在る者」 として、 同じ系譜の道を、 違う形で歩むと誓った。 千年経った今——リオラエル殿は、 シオンに「影と共に生きる」 を教え、 ヴィオレナは、 イリスを観測者として送り出した。" },
    { title: "「娘に渡す」 千年の祈り", body: "ヴィオレナは千年、 一人で巫女連邦の代表巫女として、 千年祭祀の継承を続けてきた。 母から娘へ、 母から娘へ——巫女連邦の血脈は、 千年絶えなかった。 ヴィオレナの母も、 母の母も、 そのまた母も、 皆「千年伝承の間」 の巻物に「次の代に灯る」 と書き継いだ。 ヴィオレナは、 その巻物に、 千年前、 自分の筆跡で、 こう書き加えた——「私の代に、 第四席は灯らない。 千年後、 私の娘の代に、 灯る」。 千年経った巻物の余白に、 千年分の筆跡が連なっている。 その全てが、 イリスの背中を、 千年押し続けてきた。" },
    { title: "千年経った今夜の微笑み", body: "イリスが旅立つ朝、 ヴィオレナは中央神殿の聖堂前で、 静かに微笑んでいた。 千年待った母の、 最も静かな別れの作法。 セラフィエル様が「あなたの千年は、 私の千年と、 重なるのですね」 と告げてくださった、 千年前の夜の言葉が、 今、 形になっていた。 千年血脈の母は、 ここから先——「娘の母として」 ではなく、 「彼女自身として」 の千年を、 始める。 千年前、 第四席を辞退した夜には、 まだ見えていなかった、 もう一つの千年。 ヴィオレナは、 千年経った今夜、 ようやく、 自分のための祈祷を、 始める準備が、 整った。" },
  ],
  "UR_鳳神巫女 ホムラ": [
    { title: "千年職能の継承", body: "鳳神巫女の血脈は、 千年前から代々続いている。 ホムラの祖母も、 母も、 そのまた祖母も——皆、 七座警護の頂点格として、 巫女連邦の神殿を守ってきた。 ホムラは二十七で、 既に祖母三代分の鳳神薙刀の技を継承した若き戦巫女。 「警護の千年職能は、 天上より地上に必要だ」。 これが、 鳳神巫女の代々の口伝。 ホムラはこの口伝を、 自分の墓の銘にしようと決めている。 朱の鳳凰の系譜は、 焔帝ヒノオウ様の朱の鳳凰と、 千年前、 同じ祈りから生まれた——けれど、 それは ホムラもまだ、 完全には知らない。" },
    ...
    { title: "七座入りを辞退した理由", body: "ホムラには、 過去三代の祖先が、 全て第五席「連結」 の候補に名が挙がっていた。 そして、 全員が辞退している。 ホムラ自身も、 二十二歳の時、 ノクス様から「七座候補」 の予兆を告げられた。 ホムラは、 静かに首を横に振った——「警護の千年職能は、 天上より地上に必要なのです」。 ノクス様は、 「お前の祖先と、 同じ言葉だ」 と微笑んだ。 ホムラは、 七座入りより、 「次の世代の七座着座者を地上で守る」 ことを選んだ。 イリスを十五年育てた理由は——千年前、 自分の祖先がヴィオレナを守ったのと、 同じ祈り。" },
    { title: "ヒノオウ様との並列", body: "ホムラの薙刀の柄には、 朱の鳳凰の彫刻が施されている。 これは、 千年前の鳳神巫女の祖先が、 焔帝ヒノオウ様の鳳凰「焔麗」 から、 一度だけ羽根を授かった証だ。 千年前、 ヒノオウ様の鳳凰と、 鳳神巫女の祖先が、 同じ祈りの夜に出会った——その記録は、 巫女連邦の千年伝承の間に、 静かに記されている。 ホムラはその記録を、 まだヒノオウ様には伝えていない。 「いつか、 黒月決戦の夜、 並んで戦う日が来る——その時、 お伝えします」。 朱の鳳凰の系譜は、 千年経って、 ようやく、 もう一度、 同じ戦場に立とうとしている。" },
  ],
  "SSR_大巫女 ヴィーナ": [
    { title: "千年伝承の暗誦者", body: "ヴィーナは三十二歳で大巫女に就任した。 巫女連邦の千年祭祀の歴代の祈祷文を、 全て暗誦できる「生きた記憶」。 三十二歳でその大役を担う者は、 過去千年にも数えるほどしかいない。 ヴィーナの記憶力は、 母譲りだった——母も、 暗誦の名人で、 ヴィーナに「祈祷文は、 紙の上ではなく、 体に刻め」 と教えてくれた。 ヴィーナは、 イリスが幼少の頃から、 千年伝承の祈祷文を口伝で教え続けてきた。 イリスが第四席に着座する夜、 ヴィーナは観衆の中から、 静かに、 教え子の一千年が、 始まる瞬間を見届けた。" },
    { title: "イリスへの口伝", body: "ヴィーナはイリスに、 「祈祷文は、 紙の上ではなく、 体に刻め」 と、 母から教わった通りに、 教えた。 イリスは六歳から二十一歳まで、 毎朝、 ヴィーナの元で、 千年祭祀の祈祷文を、 口伝で覚えた。 千五百年分の祈祷文を、 ヴィーナは全て暗誦している——けれど、 イリスにはそのうちの「重要な五百本」 だけ伝えた。 「残り千本は、 第四席に着座してから、 観測者の卓で、 自分で出会いなさい」。 ヴィーナの目論見は当たった。 イリスは、 月影宮で、 千年前のヴィオレナとリオラエル殿の祈祷の記録を、 自分で見つけた。" },
    { title: "次の大巫女 カヤへ", body: "ヴィーナの直弟子は、 高巫女見習いカヤ (十八)。 ヴィーナは、 カヤに、 同じ口伝の方法で、 千年祭祀を教えている。 カヤは、 イリスとは別系譜で、 「次の大巫女」 として育てられている。 ヴィーナは、 イリスが天上に上がった後、 巫女連邦の地上に残る千年祭祀の継承を、 カヤに渡す予定だ。 「あなたが大巫女になるのは、 私が老いてからではない。 あなたが、 自分の千年を、 始める時です」 — ヴィーナがカヤに、 ある夜、 静かに告げた言葉。 千年血脈の継承は、 一人ではなく、 何人もの若き者の千年を、 同時に始めることでもある。" },
  ],
  "SSR_主祭 リアラ": [
    { title: "七色の星図", body: "リアラの水晶玉には、 七色の星図が映る——観測者七座の現状を、 地上から確認できる、 千年来の聖具。 千年前、 リアラの祖先が、 月影宮の常夜の卓を一度だけ訪れた時、 ノクス様から授かった水晶。 リアラはこの水晶を、 二十代後半の今、 巫女連邦の主祭として継いでいる。 七つの星のうち、 三つだけが灯り、 四つ目が揺らぎ始めた夜——リアラは、 「もうすぐ、 第四席に座する者が、 この巫女連邦から立つ」 と、 確信した。 そして、 イリスの着座儀式を、 千年に一度の儀典として執り行った。" },
    { title: "オリオンとの天文連携", body: "リアラは月読み祭司オリオンと、 千年前から続く「天文・暦の祭司同士」 の系譜。 リアラの星図は「七座の状態」、 オリオンの天球儀は「七色の暦」 を映す——二人で合わせて読むと、 「次の七座候補が、 いつ、 どこから現れるか」 が、 推測できる。 千年前、 リアラの祖先とオリオンの祖先が、 同じ夜に協働して「第二席カグヤ様の着座時刻」 を予知したという記録が残る。 千年経った今、 リアラとオリオンは、 「次は紫——『沈黙』」 の予知に、 既に、 共に取り組み始めている。" },
    { title: "千年の儀典官", body: "観測者七座の儀式は、 千年に一度しか執り行われない。 リアラは、 千年前の儀典の記録を、 巫女連邦の千年伝承の間で、 一字一句読み込んだ。 千年前の儀典は、 リオラエル殿が地底市リオラの民を率いた夜の「影と共に生きる」 儀式と、 ほぼ同時刻に行われていた——その記録を、 リアラは知っている。 千年経った今、 イリスの第四席着座儀式と、 シオンの分離の儀式が、 数日違いで起きたことを、 リアラは「千年前の儀典の繰り返し」 だと、 静かに観察している。 千年は、 不思議な形で、 自分自身を反復する。" },
  ],
  "SSR_楽巫女 イオナ": [
    { title: "七色の音は千年の祈り", body: "イオナの七弦の琴は、 千年前から代々受け継がれてきた聖具。 七色の弦のそれぞれが、 七座の七色 (赤・橙・黄・緑・青・藍・紫) に対応している。 イオナは二十二歳で、 既に七色全ての弦を、 個別に奏でられる稀有な楽巫女。 七座満つる儀式の祭楽で、 イオナは緑の弦を、 千年ぶりに、 強く弾いた——第四席「約束」 の着座を祝う一音。 千年前、 同じ緑の弦が弾かれたのは、 ヴィオレナが第四席候補を辞退した夜——その時の音と、 千年経った今夜の音が、 巫女連邦の千年伝承の間で、 静かに重なり合った。" },
    { title: "ハジメへの指導", body: "楽人見習いハジメ (十六) は、 イオナの初めての弟子。 イオナは「楽の道は、 教えるより、 一緒に奏でることだ」 と信じている。 毎朝、 神殿の楽の祠で、 ハジメと並んで一曲ずつ奏でる。 ハジメの笛は、 まだ震える音だが、 七色のうち緑の音だけは、 既に綺麗に出る——「あなたは、 緑の音に、 才能があります」 とイオナは告げた。 ハジメは恥ずかしげに「イオナ様の七弦に、 いつか並ぶ笛を、 吹けるようになります」 と答えた。 イオナは、 千年祭祀の音楽が、 ハジメの代に、 また、 一段、 深まることを、 確信している。" },
    { title: "千年前の祭楽", body: "イオナが千年伝承の間で見つけた古文書には、 千年前の祭楽の楽譜が、 七色の墨で記されていた。 楽譜の筆跡は、 イオナの母系の祖先のもの——千年前、 第四席候補だったヴィオレナの招きを受けた月影宮で、 楽巫女が奏でた「迎えの曲」。 イオナは、 その楽譜を、 二年かけて、 七弦で再現できるように練習した。 イリスの着座儀式の祭楽の最終楽章は、 その「千年前の迎えの曲」 そのもの。 千年経って、 同じ曲が、 同じ場所で、 別の娘を迎えるために、 もう一度、 鳴った。" },
  ],
  "SSR_双子巫女姉 ノエラ": [
    { title: "妹を守る姉の祈り", body: "ノエラは、 双子の妹アシナより、 一刻だけ早く生まれた。 母から「あなたは、 妹を守るために生まれた」 と言われて育った——けれど、 ノエラはこの言葉を、 重荷とは感じなかった。 アシナの明るさが、 ノエラの静けさを、 千年伝承の中で唯一温める存在だったから。 巫女連邦の双子巫女は、 千年に一度しか生まれない希少な血脈で、 「対の祈り」 を捧げる役目を持つ。 ノエラの祈りは、 アシナの祈りと一つに重なって、 初めて完成する。 一人ではなく、 二人で一つの「対の巫女」——それが、 巫女連邦の双子巫女の千年職能。" },
    { title: "イリスへの幼馴染の温度", body: "ノエラとアシナは、 イリスと同じ二十一歳。 三人は、 物心ついた頃から、 神殿の中庭で一緒に遊んだ幼馴染。 イリスが第四席に着座する夜、 ノエラはアシナの手を握りながら、 静かに思った——「イリスは天上に上がっても、 私たちの幼馴染であり続ける」。 ノエラは、 イリスへの祝福の祈りを、 アシナと共に、 一つの「対の祈り」 として捧げた。 千年血脈の三人——イリス (第四席着座者)、 ノエラ・アシナ (双子巫女)——は、 千年経っても、 同じ神殿の中庭の記憶を、 共有し続ける。" },
    { title: "母との千年の絆", body: "ノエラとアシナの母も、 同じ双子巫女だった。 母は二人を産むとき、 「対の祈り」 が千年で初めて生まれる予兆を感じた。 二人が生まれた瞬間、 神殿の七色の灯篭が、 一斉に揺らいだ——千年前、 ヴィオレナが第四席を辞退した夜と、 同じ揺らぎ。 ノエラの母は、 それを「千年前の祈りが、 双子の形で、 戻ってきた」 と理解した。 そして、 千年血脈の最後の枝の一つとして、 ノエラとアシナは、 イリスの幼馴染という、 「対の千年職能」 を担うことになった。" },
  ],
  "SR_双子巫女妹 アシナ": [
...
const IMG_CACHE_VERSION = '1.5.1be';
