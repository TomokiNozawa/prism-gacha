...
const LORE_BY_KEY = {
  ...
  "SR_双子巫女妹 アシナ": [
    { title: "姉さまと一緒なら", body: "アシナはノエラより、 一刻だけ後に生まれた双子の妹。 「私は、 姉さまと一緒なら、 何でもできます」 が、 アシナの口癖。 静かなノエラの隣で、 明るく笑うのが、 アシナの千年職能。 七色の対の祈りは、 ノエラ単独でも、 アシナ単独でも、 完成しない——双子で、 初めて、 巫女連邦の千年祭祀の音色が、 整う。 アシナは、 自分が一人では何もできないことを、 弱さではなく、 強さだと知っている。 「対」 という存在は、 一人で完結しないことが、 その本義だから。" },
    { title: "灯篭祭の鈴鳴らし役", body: "灯篭祭の街路で、 アシナは竹鈴を鳴らす役。 ちりん、 ちりん——その音は、 街の七色の灯篭を、 一段、 揺らがせる。 アシナの鈴の音色は、 千年前から代々続く「対の祈り」 の一部。 イリスが灯篭祭でセラフィエル様を迎える夜、 アシナの鈴が、 街路の上空で、 一段、 強く鳴った——その瞬間、 セラフィエル様の翼が、 半分広がった。 千年祭祀の鈴の音は、 観測者をも、 静かに招く。" },
  ],
  "SR_月読み祭司 オリオン": [
    { title: "ノクス様の予知を地上で先取り", body: "オリオンは三十五歳で、 巫女連邦の天文祭司の頂点。 七色の星座輪が回転する天球儀杖を持ち、 ノクス様の予知を地上で先取りすることがある——千年に一度くらいの希少な才能。 オリオンが第四席着座の予兆を最初に読んだのは、 イリスが十七歳の時——「あの娘の星が、 動き始めた」。 母ヴィオレナと相談し、 イリスの剣の師ホムラと、 大巫女ヴィーナに伝え、 巫女連邦は静かに、 イリスの第四席着座への準備を、 五年かけて整えた。" },
    { title: "次は紫——『沈黙』", body: "イリスの着座儀式の夜、 オリオンは天球儀杖を構えて、 七色の星座輪を回した。 第四の環が灯る瞬間、 オリオンは、 第七の環の暗闇に、 一筋の光が走るのを見た——「次は、 紫——『沈黙』 の候補が、 動き始める」。 オリオンは、 ノクス様と同じ予知を、 同じ夜に、 地上で見た。 リアラ主祭と協議し、 巫女連邦は「次の七座候補」 への観測を、 既に、 始めている。 千年祭祀の継承は、 第四席で終わらない——次の三席が満ちるまで、 続く。" },
  ],
  "SR_神殿護衛戦士 ガレフ": [
    { title: "ホムラ様の薙刀の隣で", body: "ガレフは二十三歳で、 鳳神巫女ホムラの直属の護衛戦士隊長。 朱の頭巾と漆赤の槍は、 ホムラから直接授かった。 「ホムラ様の薙刀の隣で、 千年、 立ち続けます」——ガレフが入隊式の夜、 ホムラに誓った言葉。 ガレフの祖父も、 鳳神巫女の代々の護衛戦士だった。 千年職能の継承は、 戦巫女だけでなく、 その隣に立つ護衛戦士の系譜にも、 流れている。 ガレフは、 自分の槍が、 千年前の祖先の槍と、 同じ祈りを、 担っていることを、 静かに、 誇りに思っている。" },
    { title: "黒月決戦への密かな準備", body: "ガレフは、 月読み祭司オリオンから、 「次は、 黒月の本体が動き始める」 と、 密かに告げられている。 巫女連邦の護衛戦士隊は、 ホムラの指揮下で、 黒月決戦への準備を、 静かに、 進めている。 千年職能の戦士たちが、 全派閥の決戦に駆けつける日——その日のために、 ガレフは、 毎朝、 神殿の外庭で、 槍の練習を欠かさない。" },
  ],
  "SR_七座楽人 ハルナ": [
    { title: "千年弦の継承", body: "ハルナの七弦の竪琴は、 楽巫女イオナの七弦の琴と、 同じ千年前の祖先から授かった対の聖具。 ハルナは二十四歳で、 公式儀式の祭楽担当として、 イオナと並ぶ巫女連邦の音色の担い手。 七座儀式の祭楽で、 ハルナとイオナは、 千年前の祖先たちが奏でた「迎えの曲」 を、 二人で一つの音色として、 再現した。 千年祭祀の音楽は、 一人では完成しない——イオナとハルナの二人で、 初めて、 千年前の祭楽が、 千年経った夜に、 もう一度、 鳴る。" },
    { title: "弦の音色は千年経っても", body: "ハルナの竪琴の弦は、 千年前のものではない——千年で、 何度も張り替えられている。 けれど、 弦を張り替える時の祭祀の作法は、 千年変わらない。 「弦は変わっても、 音色は変わらない」 とハルナは信じている。 千年祭祀の継承とは、 物そのものを残すことではなく、 「音色」 を残すこと——それを、 ハルナは、 イオナから教わり、 ハジメに伝えていく。" },
  ],
  "SR_灯篭職人長 コノエ": [
    { title: "灯し直すから灯篭なのです", body: "コノエは三十八歳で、 巫女連邦の灯篭職人長。 「灯篭が消えた村跡」 にも月一で巡礼に行き、 朽ちた村の柱に、 七色の灯篭を一つだけ、 灯し直す。 千年経っても、 巡礼の民は、 この灯し直しを、 続けている。 「灯篭は、 灯し直すから、 灯篭なのです」——コノエの口癖。 千年血脈の継承は、 母から娘へ、 だけではない——千年前の灯篭を、 千年後に、 もう一度灯し直すこと、 でもある。 コノエは、 その作法を、 灯篭職人の系譜として、 千年、 続けてきた。" },
    { title: "リルへの千年継承", body: "灯篭職人見習いリル (十五) は、 コノエの直弟子。 「あなたが、 千年祭の灯篭を継ぐ若き手です」 とコノエは、 リルに伝えた。 リルは、 まだ紙竹を扱うのが拙い。 けれど、 七色の糸を編む時の集中力だけは、 既に、 コノエに迫る。 「あなたが大人になる頃、 私は、 もう、 灯篭の絵付けはできません」 とコノエは、 静かに微笑んだ。 千年職能の継承は、 老いた者が若き者に渡すこと——コノエの母も、 同じ言葉で、 コノエに、 工房の鍵を渡した。" },
  ],
  "SR_医療巫女 メア": [
    { title: "祈りも薬も同じ温度で", body: "メアは二十五歳で、 巫女連邦の医療巫女。 「祈りも薬も、 同じ温度で渡します」 が、 メアの口癖。 灯篭祭の医療所を運営し、 鳳神巫女の戦士たちの怪我も預かる。 メアの薬箱には、 七色の薬草が入っている——七色のうち緑の薬草「約束」 は、 千年血脈の傷を癒す効能がある。 イリスが第四席着座前夜に、 微熱を出した時、 メアは緑の薬草を煎じた——「あなたの千年が、 始まる前の、 最後の温度です」。 イリスは、 その薬の温度を、 千年経っても、 忘れない、 と心の中で誓った。" },
    { title: "ホムラ様の戦傷を預かる役", body: "鳳神巫女ホムラの薙刀の鍛錬は、 時に怪我を伴う。 メアは、 ホムラの右腕の鳳凰刺青の上に、 何度も傷の癒しの祈りを重ねた。 「あなたの戦士たちは、 私の患者でもあります」——メアがホムラに告げた言葉。 ホムラは、 「お前の薬箱は、 私の薙刀と同じ重さだ」 と、 微笑んだ。 巫女連邦の戦巫女と医療巫女は、 千年前から、 互いの千年職能を、 そっと支え合う系譜。 イリスが天上に上がった後、 ホムラとメアの絆は、 さらに、 深まる。" },
  ],
  "SR_高巫女見習い カヤ": [
    { title: "千年伝承の暗誦", body: "カヤは十八歳で、 大巫女ヴィーナの直弟子。 千年祭祀の祈祷文を、 既に三百本暗誦している——母系の祖先からも、 ヴィーナと同等の記憶力を引き継いだ。 「次の大巫女に、 私はなります」——カヤが十六歳の時、 ヴィーナに告げた言葉。 ヴィーナは、 静かに微笑み、 「あなたが大巫女になるのは、 私が老いてからではない。 あなたが、 自分の千年を、 始める時です」 と答えた。 カヤは、 その日から、 自分の千年職能を、 自分で見つけ始めた。" },
    { title: "次世代候補の重み", body: "カヤは、 イリスとは別系譜の「次世代候補」 として育てられている。 イリスが千年血脈で第四席に着座する一方、 カヤは千年祭祀の継承者として、 巫女連邦の地上に残る。 「あなたは、 イリスの代理ではない。 あなた自身の千年です」——ヴィーナは、 千年血脈の母系の言葉を、 そのまま、 カヤに伝えた。 カヤは、 その重みを、 静かに、 受け止めた。 千年職能の継承は、 一人ではなく、 同じ世代の何人もの若き者が、 同時に、 自分の千年を始めることでもある。" },
  ],
  "R_巫女見習い アヤメ": [
    { title: "灯篭、 落とさないように", body: "アヤメは十六歳の見習い。 灯篭祭の蝋燭灯篭を運ぶ補助役で、 「灯篭、 落とさないようにしますね」 が口癖。 緑のリボンを編み込んだ髪、 明るい緑の瞳。 アヤメの祖母も、 同じ役を担っていた。 千年職能の継承は、 大巫女の暗誦だけではない——一つの灯篭を、 落とさず運ぶ、 ささやかな祈りも、 千年血脈の一部。" },
  ],
  "R_巫女見習い スズ": [
    { title: "ちりん、 ちりん", body: "スズは十五歳の見習い。 灯篭祭の鈴鳴らし役で、 銀金の短髪に小さな三つ編み。 「ちりん、 ちりん——」 という音色は、 双子巫女妹アシナの鈴の音色と、 同じ千年前の祖先から、 引き継がれた音。 スズの鈴は、 アシナの鈴より、 一段、 高い音——「対の祈り」 の中の、 もう一つの音色。" },
  ],
  "R_巫女見習い ハナ": [
    { title: "桃の花びら、 散らしますね", body: "ハナは十七歳の見習い。 灯篭祭の散華 (花びらを撒く) 役。 淡桃色の長髪を双子おさげ、 桃紫の瞳。 物静かな性格だが、 散華の作法だけは、 千年血脈の最年少の正確さ。 ハナが撒く桃の花びらは、 必ず、 七色の灯篭の方向に、 七つ、 揃う——千年経っても、 同じ作法。" },
  ],
  "R_巫女見習い ユウ": [
    { title: "神殿、 きれいにしておきます", body: "ユウは十六歳の見習い。 神殿の階段の清掃役で、 淡ラベンダーの短髪、 淡青の瞳。 寡黙だが丁寧な性格。 「祈祷文を覚えるのは苦手ですが、 神殿の床は、 千年経っても、 きれいにします」——ユウが大巫女ヴィーナに告げた、 唯一の口数の多い言葉。 ヴィーナは、 静かに微笑み、 「それも、 千年職能の一つです」 と答えた。" },
  ],
  "R_楽人見習い ハジメ": [
    { title: "震える音、 緑の才能", body: "ハジメは十六歳で、 楽巫女イオナの初めての弟子。 木製の縦笛を学ぶ少年で、 銀の短髪、 銀灰の瞳。 ハジメの笛は、 まだ震える音だが、 七色のうち緑の音だけは、 既に綺麗に出る——イオナから「緑の才能」 と告げられた。 「いつか、 イオナ様の七弦に並ぶ笛を、 吹けるようになります」——ハジメの誓い。 千年職能の楽人系譜は、 母系から娘へ、 だけでなく、 兄弟弟子の中で、 一段ずつ深まる。" },
  ],
  "R_灯篭職人見習い リル": [
    { title: "千年祭の灯篭を継ぐ若き手", body: "リルは十五歳で、 灯篭職人長コノエの直弟子。 焦茶の短髪に七色の糸の三つ編み、 ハシバミ色の瞳。 紙竹の扱いはまだ拙いが、 七色の糸を編む集中力は、 既にコノエに迫る。 「あなたが、 千年祭の灯篭を継ぐ若き手です」——コノエがリルに告げた言葉。 リルの祖母も、 同じ工房で、 灯篭の絵付けを担っていた。 千年職能の灯篭の系譜は、 こうして、 三代を超えて、 続いていく。" },
  ],
  ...
  "UR_塔主 ザナディア": [
    { title: "千年前ヴォイドラ召喚の夜", body: "ザナディアは千年前、 まだ若き巫女だった。 同時代を生きたリオラエル殿 (s1c5、 地底市) とヴィオレナ (s1c6、 巫女連邦) と並んで、 千年級存在の血脈を受け継いだ。 三人とも、 月影宮で共に祈った夜の記憶を持つ。 だがザナディアだけは、 観測者の道を選ばなかった。 代わりに、 異界塔ザナドで、 千年閉じ込められていた「観測されない存在」 ヴォイドラを召喚した。 『あなたは、 確かに、 在ります』——ザナディアの最初の言葉。 ヴォイドラは静かに頷き、 二人は千年、 塔に閉じこもることを選んだ。" },
  ...
  "SSR_紅玉旗艦砲手長 マロン": [
    { title: "シャンティとの戦友関係", body: "マロンは、 シャンティ船長 (s1c2 UR 紅玉海賊団船長) と、 千年級の戦友関係。 シャンティが双剣で前線、 マロンが砲撃で後衛——双剣 vs 砲撃の戦闘スタイルで、 完全な役割分担。 「撃つぞ! 副長は航海頼んだ!」——マロンの戦場での号令。 ケイレブ (s1c2 SSR 副長) が航海を担い、 マロンが砲撃を担う、 三役分担が紅玉海賊団の core。" },
    { title: "旗艦砲の威力", body: "紅玉号の旗艦砲は、 千年前にシャンティの祖父が鋳造した、 海賊団の聖具。 マロンは、 千年血脈の砲手の系譜を継ぐ、 三代目の砲手長。 brass-gold の rifle-cannon は、 千年同じ砲座に据えられ、 代々の砲手たちが同じ威力を継いできた。 黒月決戦で、 マロンの砲撃が、 異界塔戦士団の隊列を、 一発で散らせる威力を発揮した。" },
    { title: "ミカへの千年血脈の継承", body: "マロンは、 海賊見習いミカ (s1c2 R) を、 千年血脈の砲手の継承者として育てている。 ミカは、 まだ十二歳の子供だが、 砲撃の感覚は、 既にマロンを驚かせる才能。 「お前が、 千年血脈の砲手の四代目になる」——マロンがミカに、 静かに告げた言葉。 千年血脈の継承は、 戦場の中で、 静かに進んでいく。" },
  ],
  "SSR_古龍王の使者 アグル": [
