/* ============================================================
   Prismaera v1.7.0d — 演出&ゲームロジック (Season 1 第1〜2章) / dev は cache buster suffix で進行
   ============================================================ */
"use strict";
...
const POOL = {
  ...
  UR: [
    ...
    // ===== S1C7 追加 (UR5、 異界塔ザナド+共観の使徒+第七席候補) =====
    {
      ...
      desc: "千年前にヴォイドラを召喚し、 共に異界塔ザナドに閉じ込められた塔主。 千年級存在として、 リオラエル殿 (s1c5、 地底市) と同時代を生きた。 紫銀の長髪、 紫水晶の瞳、 七色の召喚陣が刺繍された千年塔主の衣。 黒月決戦でプリズマとヴォイドラの対話を見届け、 千年の幽閉から解放される。",
    ...
    },
    {
      ...
      desc: "千年閉じ込められた異界塔ザナドの中で 元から影として生まれたヴォイドラ第一使徒。 シ・ロエン (s1c5、 シオン分離後の影) とは別系統の影。 漆黒の単刃曲剣、 半割れの紫縁の仮面。 シ・ロエンに「異界塔ザナドへの誘い」 を持ちかける役割。 シオン×シ・ロエン再会の前夜にもう一つの影として戦場に立つ、 黒月衆ノクトリアとは別陣営の異界塔ザナド直属。",
    ...
    },
    {
      ...
      desc: "ヴォイドラ陣営の千年級女性使徒。 黒月衆の先代盟主と千年前に交わした「影の側の引き受け」 の盟約が、 現代のノクトリア (s1c5) の代まで黒月衆と異界塔ザナドの繋がりとして受け継がれてきた。 紫黒のロングヘア、 七つの逆三日月の刺青、 双刃の虚無の長刃を構える。 千年閉じ込めの対価を覚悟しながらヴォイドラと共に閉じこもった同胞。",
    ...
    },
    {
      ...
      caption: "(沈黙、 言葉なし)",
      desc: "観測者七座の第七席「沈黙」 (紫) 候補として黒月決戦に静かに顔を出す両性的な若き存在。 縫い口の紋の衣装、 灯らぬ灯篭、 意図的な空白の柱、 「沈黙」 を象徴する装飾の意図的欠落。 s1c6 ノクス予知「これでも足りない」 の直接顔出し。 七座満つる時代の最後のピース。",
  ...
  SSR: [
    ...
    },
    {
      ...
      desc: "紅玉海賊団の旗艦砲手長、 二十七-二十八。 シャンティ (s1c2 UR 紅玉海賊団船長) の戦闘の戦友、 副長ケイレブ (s1c2 SSR) の航海能力と独立した「砲撃指揮」 特化。 真鍮金のライフル砲、 三角帽の紅羽飾り、 黒バンダナで前線を撃つ。",
    ...
    },
    {
      ...
      desc: "空挺城ゼノニアの艦隊司令、 二十六-二十七。 ヴァーレ (s1c4 UR 空挺女皇) 配下の軍事側補佐、 ガリオン (s1c4 SSR 空挺城総監=都市行政) と独立した「艦隊司令」。 真鍮金の艦長帽、 蒸気剣、 真鍮の双眼鏡を構える艦隊指揮官。",
    ...
    },
    {
      ...
      desc: "巫女連邦リーリエの軍師、 二十五-二十六。 ホムラ (s1c6 UR 鳳神巫女=戦巫女頂点) と独立した「戦略担当」 として全派閥連携の中枢を担う。 翡翠と銅の戦略服、 七色の作戦扇子を開いて指揮を行う。 黒月決戦の全派閥戦略を一冊の絵巻に集約する役。",
    ...
    },
    {
      ...
      desc: "異界塔ザナドの執行官、 二十七-二十八。 ザナディア (UR 塔主) 配下の戦術指揮、 異界塔戦士団の総大将。 異界塔の軍服、 砕けた三日月の紋章、 紫黒のロングソード。 ノクトリア (s1c5 黒月衆盟主) と並ぶ「敵側 SSR 旗手」 の格、 黒月決戦の主敵指揮官として全派閥と対峙する。",
  ...
  SR: [
    ...
    },
    {
      ...
      desc: "異界塔ザナドの若き闇衛、 二十一-二十二。 オブスクル (SSR 執行官) 配下の戦闘部隊、 砕けた三日月の紋章の虚無黒の鎧、 異界塔の前線兵。 黒月決戦で全派閥と戦う。",
    ...
    },
    {
      ...
      caption: "影の咒術を、 解き放つ。",
      desc: "異界塔ザナドの若き闇魔導士、 二十一-二十二。 砕けた三日月の刺繍の虚無魔導衣、 黒曜の虚無魔導杖。 闇の咒術担当、 凍土陣営との魔法戦の前線。",
    ...
    },
    {
      ...
      desc: "異界塔ザナドの若き斥候、 二十-二十一。 影の中を歩く偵察、 戦線の情報伝達役。 虚無黒の斥候装、 虚無黒の双短剣を逆手で構える両性的な存在。 シ・ロエン接触の前哨偵察を担う。",
  ...
  R: [
    ...
    // ===== S1C7 追加 (R5、 異界塔の小兵+各派閥の名もなき戦士) =====
    {
      ...
      desc: "異界塔ザナドの若き伝令、 十八-十九歳。 影の翼で空を飛び、 異界塔戦士団の各戦線に塔主の意志を届ける伝令役。 砕けた三日月の旗、 黒曜の巻物、 影の小翼で機動する両性的な存在。",
    ...
    },
    {
      ...
      caption: "刃よ、 影を切り裂け……。",
      desc: "異界塔ザナドの若き鍛冶、 十八-十九歳。 黒曜の鉄床で虚無の武具を作る、 千年閉じこもった鍛冶炉を再び動かす一人。 短く乱れた漆黒の髪、 紫の焔のキャラクター性。",
    ...
    },
    {
      ...
      desc: "異界塔ザナドの若き歌手、 十八-十九歳。 虚無の歌手として千年閉じ込められた塔の祈祷歌を歌い続ける。 深紫のドレス、 紫の古琴を抱える夢のような若き歌姫。 メルの歌声が異界塔派閥 BGM の詠唱担当。",
    ...
    },
    {
      ...
      desc: "白焔教会の若き救護担当、 十八-十九歳。 戦場で負傷者を助ける救護役、 治癒の杖と包帯で前線兵を治す。 教会陣営の戦場救護要員、 オーレン (SSR 団長) 配下のサポート系。",
