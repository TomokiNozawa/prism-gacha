"""s1c7 場所画像 14枚 を Box から repo へ取込 + thumb 自動生成 (s1c5/s1c6 と同フロー)。

Box: C:/Users/t2262/Box/.../prismaera/images/locations/s1c7/
→ repo: ~/prism-gacha-work/images/locations/s1c7/{filename}.png
→ repo: ~/prism-gacha-work/images/locations/s1c7/thumb/{filename}_thumb.webp
"""
import os
import shutil
from PIL import Image

BOX_SRC = r"C:/Users/t2262/Box/DIK & Company/06_Other/野沢用/claude/prismaera/images/locations/s1c7"
REPO_DST = r"C:/Users/t2262/prism-gacha-work/images/locations/s1c7"
