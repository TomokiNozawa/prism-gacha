...
- **S1C6 仕込み伏線 (新規、 outline.md 伏線リスト記載済)**:
  ...
  - イリス継承血脈 (ヴィオレナ系譜) → S2C6 新たな七座
  - ヴィオレナ (半世紀級長老) vs リオラエル殿 (千年級) 対比 → S2C4 / S2C5
...
| 10 | shrine_oracle_reunion.png | 16:9 | 挿絵 | 2-1 神殿でセラフィエル+ヴィオレナ再会 (半世紀ぶり) | セラフィエル+ヴィオレナ | 添付2枚 + 背景 #4 添付 |
...
| 13 | iris_departure_morning.png | 16:9 | 挿絵 | 4-2 別れの朝 (イリス地上へ、 ヴィオレナ「半世紀待った」) | セラフィエル+イリス+ヴィオレナ | 添付3枚 + 背景 #4 添付 |
