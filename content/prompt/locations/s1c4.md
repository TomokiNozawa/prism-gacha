...
| 11 | frost_swordmaster_sparring.png | 16:9 | ⚠️削除済 | INLINE 配置から削除済 (2026-05-03 野沢さん指摘 「意味不明」)、 ファイル自体は将来再利用に備えて保持 | — |
...
- **先行画像 添付**: `images/locations/s1c4/zenonia_floating_fortress.png` (#4、 空挺城ゼノニア外観 = 同シーン背景、 ルール7-35 整合)
...
- **先行画像 添付**: `images/locations/s1c4/frost_tundra_journey.png` (#2、 凍土への旅路 = 同シーン背景、 ルール7-35 整合)
...
- **先行画像 添付**: `images/locations/s1c4/niiruru_ice_palace.png` (#3、 氷宮殿の謁見の間 = 同シーン背景、 ルール7-35 整合)
